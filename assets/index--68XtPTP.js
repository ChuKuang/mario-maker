...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _o(e,t,n){let r=new Float32Array(no),i=new V(0,1,0);return new Wi({name:`SphericalGaussianBlur`,defines:{n:no,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(){return new Wi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(){return new Wi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bo(),fragmentShader:`
	...
	`}var xo=class extends jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Rs(i,i.VERTEX_SHADER,y),S=Rs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ws(i,x,`vertex`),n=Ws(i,S,`fragment`);R(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,Xc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Oi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Wi({vertexShader:Jc,fragmentShader:Yc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new W(new Mi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Zc=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Xc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new B,te=null,O=new xa;O.viewport=new kt;let ne=new xa;ne.viewport=new kt;let k=[O,ne],A=new Oa,re=null,ie=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getHandSpace()};function j(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,j),r.removeEventListener(`selectstart`,j),r.removeEventListener(`selectend`,j),r.removeEventListener(`squeeze`,j),r.removeEventListener(`squeezestart`,j),r.removeEventListener(`squeezeend`,j),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,ie=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(te),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,j),r.addEventListener(`selectstart`,j),r.addEventListener(`selectend`,j),r.addEventListener(`squeeze`,j),r.addEventListener(`squeezestart`,j),r.addEventListener(`squeezeend`,j),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),te=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new jt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new Ei(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new jt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let se=new V,ce=new V;function M(e,t,n){se.setFromMatrixPosition(t.matrixWorld),ce.setFromMatrixPosition(n.matrixWorld);let r=se.distanceTo(ce),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=ne.near=O.near=t,A.far=ne.far=O.far=n,(re!==A.near||ie!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,ie=A.far),A.layers.mask=e.layers.mask|6,O.layers.mask=A.layers.mask&-5,ne.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;le(A,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?M(A,O,ne):A.projectionMatrix.copy(O.projectionMatrix),ue(e,A,i)};function ue(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(f!==null||p!==null)return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let de=null;function fe(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=k[n];o===void 0&&(o=new xa,o.layers.enable(n),o.viewport=new kt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Oi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}de&&de(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let pe=new Ua;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){de=e},this.dispose=function(){}}},Qc=new Pt,$c=new H;$c.set(-1,0,0,0,1,0,0,0,1);function el(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Bi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Qc.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply($c),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function tl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):ArrayBuffer.isView(o)?i.__data.set(new o.constructor(o.buffer,o.byteOffset,i.__data.length)):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var nl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),rl=null;function il(){return rl===null&&(rl=new ni(nl,16,16,te,g),rl.name=`DFG_LUT`,rl.minFilter=o,rl.magFilter=o,rl.wrapS=t,rl.wrapT=t,rl.generateMipmaps=!1,rl.needsUpdate=!0),rl}var al=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ne,O,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new V,te=null,k=null,A=[],re=[],ie=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ae=!1,oe=null;this._outputColorSpace=ze;let se=0,ce=0,M=null,le=-1,ue=null,de=new kt,fe=new kt,pe=null,me=new U(0),he=0,ge=t.width,_e=t.height,ve=1,ye=null,be=null,xe=new kt(0,0,ge,_e),Se=new kt(0,0,ge,_e),Ce=!1,we=new ui,Te=!1,Ee=!1,De=new Pt,Oe=new V,ke=new kt,Ae={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},je=!1;function Me(){return M===null?ve:1}let N=n;function Ne(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r184`),t.addEventListener(`webglcontextlost`,z,!1),t.addEventListener(`webglcontextrestored`,st,!1),t.addEventListener(`webglcontextcreationerror`,ct,!1),N===null){let t=`webgl2`;if(N=Ne(t,e),N===null)throw Ne(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Pe,Fe,P,Ie,F,I,Le,Re,Be,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it;function at(){Pe=new Co(N),Pe.init(),nt=new qc(N,Pe),Fe=new Qa(N,Pe,e,nt),P=new Gc(N,Pe),Fe.reversedDepthBuffer&&h&&P.buffers.depth.setReversed(!0),Ie=new Eo(N),F=new Tc,I=new Kc(N,Pe,P,F,Fe,nt,Ie),Le=new So(j),Re=new Wa(N),rt=new Xa(N,Re),Be=new wo(N,Re,Ie,rt),Ve=new Oo(N,Be,Re,rt,Ie),Qe=new Do(N,Fe,I),qe=new $a(F),He=new wc(j,Le,Pe,Fe,rt,qe),Ue=new el(j,F),We=new kc,Ke=new Ic(Pe),Xe=new Ya(j,Le,P,Ve,x,s),Je=new Wc(j,Ve,Fe),it=new tl(N,Ie,Fe,P),$e=new Za(N,Pe,Ie),tt=new To(N,Pe,Ie),Ie.programs=He.programs,j.capabilities=Fe,j.extensions=Pe,j.properties=F,j.renderLists=We,j.shadowMap=Je,j.state=P,j.info=Ie}at(),S!==1009&&(ie=new Ao(S,t.width,t.height,r,i));let ot=new Zc(j,N);this.xr=ot,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Pe.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Pe.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ve},this.setPixelRatio=function(e){e!==void 0&&(ve=e,this.setSize(ge,_e,!1))},this.getSize=function(e){return e.set(ge,_e)},this.setSize=function(e,n,r=!0){if(ot.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ge=e,_e=n,t.width=Math.floor(e*ve),t.height=Math.floor(n*ve),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ie!==null&&ie.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ge*ve,_e*ve).floor()},this.setDrawingBufferSize=function(e,n,r){ge=e,_e=n,ve=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){R(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){L(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ie.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(de)},this.getViewport=function(e){return e.copy(xe)},this.setViewport=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),P.viewport(de.copy(xe).multiplyScalar(ve).round())},this.getScissor=function(e){return e.copy(Se)},this.setScissor=function(e,t,n,r){e.isVector4?Se.set(e.x,e.y,e.z,e.w):Se.set(e,t,n,r),P.scissor(fe.copy(Se).multiplyScalar(ve).round())},this.getScissorTest=function(){return Ce},this.setScissorTest=function(e){P.setScissorTest(Ce=e)},this.setOpaqueSort=function(e){ye=e},this.setTransparentSort=function(e){be=e},this.getClearColor=function(e){return e.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor(...arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=C.has(t)}if(e){let e=M.texture.type,t=w.has(e),n=Xe.getClearColor(),r=Xe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,N.clearBufferuiv(N.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,N.clearBufferiv(N.COLOR,0,E))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),oe=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,z,!1),t.removeEventListener(`webglcontextrestored`,st,!1),t.removeEventListener(`webglcontextcreationerror`,ct,!1),Xe.dispose(),We.dispose(),Ke.dispose(),F.dispose(),Le.dispose(),Ve.dispose(),rt.dispose(),it.dispose(),He.dispose(),ot.dispose(),ot.removeEventListener(`sessionstart`,H),ot.removeEventListener(`sessionend`,mt),ht.stop()};function z(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ae=!0}function st(){Ze(`WebGLRenderer: Context Restored.`),ae=!1;let e=Ie.autoReset,t=Je.enabled,n=Je.autoUpdate,r=Je.needsUpdate,i=Je.type;at(),Ie.autoReset=e,Je.enabled=t,Je.autoUpdate=n,Je.needsUpdate=r,Je.type=i}function ct(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function lt(e){let t=e.target;t.removeEventListener(`dispose`,lt),ut(t)}function ut(e){B(e),F.remove(e)}function B(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){He.releaseProgram(e)}),e.isShaderMaterial&&He.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ae);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=Et(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Be.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;rt.setup(i,r,s,n,c);let h,g=$e;if(c!==null&&(h=Re.get(c),g=tt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Me()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Me()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh){if(Pe.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Re.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function dt(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,St(e,t,n),e.side=0,e.needsUpdate=!0,St(e,t,n),e.side=2):St(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Ke.get(n),k.init(t),re.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t){if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];dt(a,n,e),r.add(a)}else dt(t,n,e),r.add(t)}}),k=re.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Pe.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ft=null;function pt(e){ft&&ft(e)}function H(){ht.stop()}function mt(){ht.start()}let ht=new Ua;ht.setAnimationLoop(pt),typeof self<`u`&&ht.setContext(self),this.setAnimationLoop=function(e){ft=e,ot.setAnimationLoop(e),e===null?ht.stop():ht.start()},ot.addEventListener(`sessionstart`,H),ot.addEventListener(`sessionend`,mt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ae===!0)return;oe!==null&&oe.renderStart(e,t);let n=ot.enabled===!0&&ot.isPresenting===!0,r=ie!==null&&(M===null||n)&&ie.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ot.enabled===!0&&ot.isPresenting===!0&&(ie===null||ie.isCompositing()===!1)&&(ot.cameraAutoUpdate===!0&&ot.updateCamera(t),t=ot.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),k=Ke.get(e,re.length),k.init(t),k.state.textureUnits=I.getTextureUnits(),re.push(k),De.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),we.setFromProjectionMatrix(De,Ge,t.reversedDepth),Ee=this.localClippingEnabled,Te=qe.init(this.clippingPlanes,Ee),te=We.get(e,A.length),te.init(),A.push(te),ot.enabled===!0&&ot.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&gt(e,t,-1/0,j.sortObjects)}gt(e,t,0,j.sortObjects),te.finish(),j.sortObjects===!0&&te.sort(ye,be),je=ot.enabled===!1||ot.isPresenting===!1||ot.hasDepthSensing()===!1,je&&Xe.addToRenderList(te,e),this.info.render.frame++,Te===!0&&qe.beginShadows();let i=k.state.shadowsArray;if(Je.render(i,e,t),Te===!0&&qe.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&ie.hasRenderPass())===!1){let n=te.opaque,r=te.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];yt(n,r,e,a)}je&&Xe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];_t(te,e,n,n.viewport)}}else r.length>0&&yt(n,r,e,t),je&&Xe.render(e),_t(te,e,t)}M!==null&&ce===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&ie.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),rt.resetDefaultState(),le=-1,ue=null,re.pop(),re.length>0?(k=re[re.length-1],I.setTextureUnits(k.state.textureUnits),Te===!0&&qe.setGlobalState(j.clippingPlanes,k.state.camera)):k=null,A.pop(),te=A.length>0?A[A.length-1]:null,oe!==null&&oe.renderEnd()};function gt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||we.intersectsSprite(e)){r&&ke.setFromMatrixPosition(e.matrixWorld).applyMatrix4(De);let t=Ve.update(e),i=e.material;i.visible&&te.push(e,t,i,n,ke.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||we.intersectsObject(e))){let t=Ve.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),ke.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),ke.copy(e.boundingSphere.center)),ke.applyMatrix4(e.matrixWorld).applyMatrix4(De)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&te.push(e,t,s,n,ke.z,o)}}else i.visible&&te.push(e,t,i,n,ke.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)gt(i[e],t,n,r)}function _t(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Te===!0&&qe.setGlobalState(j.clippingPlanes,n),r&&P.viewport(de.copy(r)),i.length>0&&bt(i,t,n),a.length>0&&bt(a,t,n),o.length>0&&bt(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function yt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Pe.has(`EXT_color_buffer_half_float`)||Pe.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new jt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Fe.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:vt.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||de;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(me),he=j.getClearAlpha(),he<1&&j.setClearColor(16777215,.5),j.clear(),je&&Xe.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Te===!0&&qe.setGlobalState(j.clippingPlanes,r),bt(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Pe.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,xt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(me,he),p!==void 0&&(r.viewport=p),j.toneMapping=f}function bt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&xt(o,t,n,s,l,c)}}function xt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function St(e,t,n){t.isScene!==!0&&(t=Ae);let r=F.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=He.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=He.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Le.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,lt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return wt(e,s),d}else s.uniforms=He.getUniforms(e),oe!==null&&e.isNodeMaterial&&oe.build(e,n,s),e.onBeforeCompile(s,j),d=He.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=qe.uniform),wt(e,s),r.needsLights=Ot(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Ct(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Ls.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function wt(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Tt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Et(e,t,n,r,i){t.isScene!==!0&&(t=Ae),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:vt.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Le.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=k.state.lights;if(Te===!0&&(Ee===!0||e!==ue)){let t=e===ue&&r.id===le;qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==qe.numPlanes||v.numIntersection!==qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=St(r,t,i),oe&&r.isNodeMaterial&&oe.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==le&&(le=r.id,C=!0),v.needsLights){let e=Tt(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||ue!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,Oe.setFromMatrixPosition(e.matrixWorld)),Fe.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),ue!==e&&(ue=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Qe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=il()),C){if(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&Dt(E,w),a&&r.fog===!0&&Ue.refreshFogUniforms(E,a),Ue.refreshMaterialUniforms(E,r,ve,_e,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Ls.upload(N,Ct(v),E,I)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Ls.upload(N,Ct(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];it.update(n,x),it.bind(n,x)}}return x}function Dt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Ot(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return se},this.getActiveMipmapLevel=function(){return ce},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let At=N.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){M=e,se=t,ce=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),de.copy(e.viewport),fe.copy(e.scissor),pe=e.scissorTest,P.viewport(de),P.scissor(fe),P.setScissorTest(pe),le=-1;return}if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,de.copy(e.viewport),fe.copy(e.scissor),pe=e.scissorTest}else de.copy(xe).multiplyScalar(ve).floor(),fe.copy(Se).multiplyScalar(ve).floor(),pe=Ce;if(n!==0&&(r=At),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(de),P.scissor(fe),P.setScissorTest(pe),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}le=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Fe.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Fe.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,nt.convert(c),nt.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Fe.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Fe.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,nt.convert(l),nt.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await et(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()};let Mt=N.createFramebuffer(),Nt=N.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=nt.convert(t.format),_=nt.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),P.activeTexture(N.TEXTURE0),P.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),P.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),P.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=P.getParameter(N.UNPACK_ROW_LENGTH),b=P.getParameter(N.UNPACK_IMAGE_HEIGHT),x=P.getParameter(N.UNPACK_SKIP_PIXELS),S=P.getParameter(N.UNPACK_SKIP_ROWS),C=P.getParameter(N.UNPACK_SKIP_IMAGES);P.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),P.pixelStorei(N.UNPACK_SKIP_PIXELS,l),P.pixelStorei(N.UNPACK_SKIP_ROWS,u),P.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,Mt),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,Nt);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);P.pixelStorei(N.UNPACK_ROW_LENGTH,y),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),P.pixelStorei(N.UNPACK_SKIP_PIXELS,x),P.pixelStorei(N.UNPACK_SKIP_ROWS,S),P.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){se=0,ce=0,M=null,P.reset(),rt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=vt._getDrawingBufferColorSpace(e),t.unpackColorSpace=vt._getUnpackColorSpace()}},ol=class{stick;knob;jumpButton;dashButton;canvas;keys=new Set;pressed=new Set;pointerState={active:!1,id:null,centerX:0,centerY:0,radius:1};stickX=0;stickY=0;stickActive=!1;touchJump=!1;touchDash=!1;jumpWasDown=!1;pauseWasDown=!1;intents={moveX:0,jumpPressed:!1,jumpHeld:!1,dashHeld:!1,downHeld:!1,pausePressed:!1,pointerX:0,pointerY:0,pointerDown:!1,pointerDownPrev:!1,pointerAlt:!1,eraserHeld:!1};onKeyDown=e=>{e.repeat||(this.keys.add(e.code),this.pressed.add(e.code),(e.code===`Space`||e.code===`ArrowUp`||e.code===`ArrowDown`||e.code===`ArrowLeft`||e.code===`ArrowRight`)&&e.preventDefault())};onKeyUp=e=>{this.keys.delete(e.code)};onBlur=()=>{this.keys.clear(),this.touchJump=!1,this.touchDash=!1,this.stickActive=!1,this.stickX=0,this.stickY=0};onStickDown=e=>{e.preventDefault();let t=this.stick.getBoundingClientRect();this.pointerState.active=!0,this.pointerState.id=e.pointerId,this.pointerState.centerX=t.left+t.width/2,this.pointerState.centerY=t.top+t.height/2,this.pointerState.radius=t.width*.42;try{this.stick.setPointerCapture(e.pointerId)}catch{}this.stickActive=!0,this.updateStick(e.clientX,e.clientY)};onStickMove=e=>{this.pointerState.active&&e.pointerId===this.pointerState.id&&(e.preventDefault(),this.updateStick(e.clientX,e.clientY))};onStickUp=e=>{e.pointerId===this.pointerState.id&&(e.preventDefault(),this.pointerState.active=!1,this.pointerState.id=null,this.stickActive=!1,this.stickX=0,this.stickY=0,this.updateKnob())};onJumpDown=e=>{e.preventDefault(),this.touchJump=!0};onJumpUp=e=>{e.preventDefault(),this.touchJump=!1};onDashDown=e=>{e.preventDefault(),this.touchDash=!0};onDashUp=e=>{e.preventDefault(),this.touchDash=!1};constructor(e,t,n,r,i){this.stick=e,this.knob=t,this.jumpButton=n,this.dashButton=r,this.canvas=i,window.addEventListener(`keydown`,this.onKeyDown),window.addEventListener(`keyup`,this.onKeyUp),window.addEventListener(`blur`,this.onBlur),this.stick.addEventListener(`pointerdown`,this.onStickDown),this.stick.addEventListener(`pointermove`,this.onStickMove),this.stick.addEventListener(`pointerup`,this.onStickUp),this.stick.addEventListener(`pointercancel`,this.onStickUp),this.jumpButton.addEventListener(`pointerdown`,this.onJumpDown),this.jumpButton.addEventListener(`pointerup`,this.onJumpUp),this.jumpButton.addEventListener(`pointercancel`,this.onJumpUp),this.dashButton.addEventListener(`pointerdown`,this.onDashDown),this.dashButton.addEventListener(`pointerup`,this.onDashUp),this.dashButton.addEventListener(`pointercancel`,this.onDashUp),this.dashButton.addEventListener(`pointerleave`,this.onDashUp),this.canvas.addEventListener(`contextmenu`,e=>e.preventDefault())}poll(){let e=this.intents;e.pointerDownPrev=e.pointerDown;let t=0;(this.keys.has(`KeyA`)||this.keys.has(`ArrowLeft`))&&--t,(this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`))&&(t+=1),this.stickActive&&(this.stickX<-.25&&--t,this.stickX>.25&&(t+=1)),e.moveX=sl(t);let n=this.keys.has(`Space`)||this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`)||this.keys.has(`KeyZ`)||this.touchJump;e.jumpHeld=n,e.jumpPressed=n&&!this.jumpWasDown,this.jumpWasDown=n,e.dashHeld=this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`)||this.keys.has(`KeyX`)||this.touchDash,e.downHeld=this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`)||this.stickActive&&this.stickY>.4;let r=this.keys.has(`Escape`)||this.keys.has(`KeyP`);return e.pausePressed=r&&!this.pauseWasDown,this.pauseWasDown=r,e.eraserHeld=this.keys.has(`KeyE`),this.pressed.clear(),e}wasKeyPressed(e){return this.pressed.has(e)}setPointerFromClient(e,t,n,r){let i=this.canvas.getBoundingClientRect();this.intents.pointerX=e-i.left,this.intents.pointerY=t-i.top,this.intents.pointerDown=n,this.intents.pointerAlt=r}dispose(){window.removeEventListener(`keydown`,this.onKeyDown),window.removeEventListener(`keyup`,this.onKeyUp),window.removeEventListener(`blur`,this.onBlur),this.stick.removeEventListener(`pointerdown`,this.onStickDown),this.stick.removeEventListener(`pointermove`,this.onStickMove),this.stick.removeEventListener(`pointerup`,this.onStickUp),this.stick.removeEventListener(`pointercancel`,this.onStickUp),this.jumpButton.removeEventListener(`pointerdown`,this.onJumpDown),this.jumpButton.removeEventListener(`pointerup`,this.onJumpUp),this.jumpButton.removeEventListener(`pointercancel`,this.onJumpUp),this.dashButton.removeEventListener(`pointerdown`,this.onDashDown),this.dashButton.removeEventListener(`pointerup`,this.onDashUp),this.dashButton.removeEventListener(`pointercancel`,this.onDashUp),this.dashButton.removeEventListener(`pointerleave`,this.onDashUp)}updateStick(e,t){let n=e-this.pointerState.centerX,r=t-this.pointerState.centerY,i=n/this.pointerState.radius,a=r/this.pointerState.radius,o=Math.hypot(i,a);o>1&&(i/=o,a/=o),this.stickX=i,this.stickY=a,this.updateKnob()}updateKnob(){this.knob.style.transform=`translate(calc(-50% + ${this.stickX*36}px), calc(-50% + ${this.stickY*36}px))`}};function sl(e){return e<-1?-1:e>1?1:e}var cl=class{update;render;frameId=0;lastTime=0;running=!1;constructor(e,t){this.update=e,this.render=t}start(){this.running||(this.running=!0,this.lastTime=performance.now(),this.frameId=requestAnimationFrame(this.tick))}stop(){this.running=!1,cancelAnimationFrame(this.frameId)}tick=e=>{if(!this.running)return;let t=Math.min((e-this.lastTime)/1e3,.05);this.lastTime=e,this.update(t,e/1e3),this.render(),this.frameId=requestAnimationFrame(this.tick)}};function ll(e){let t=new al({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`});return t.outputColorSpace=ze,t.toneMapping=4,t.toneMappingExposure=1.05,t.shadowMap.enabled=!0,t.shadowMap.type=1,t}function ul(e,t,n=2){let r=e.domElement,i=Math.max(1,Math.floor(r.clientWidth)),a=Math.max(1,Math.floor(r.clientHeight)),o=Math.min(window.devicePixelRatio||1,n),s=Math.floor(i*o),c=Math.floor(a*o),l=r.width!==s||r.height!==c;if(l){e.setPixelRatio(o),e.setSize(i,a,!1);let n=t;n.isPerspectiveCamera&&(n.aspect=i/a,n.updateProjectionMatrix())}return l}var Y={Empty:0,Ground:1,Brick:2,Question:3,UsedBlock:4,PipeTopL:5,PipeTopR:6,PipeBodyL:7,PipeBodyR:8,Platform:9,Spike:10,Spring:11,Ice:12,Lava:13,Bridge:14,PlatformH:15,PlatformV:16,Coin:20,Goomba:30,Koopa:31,Spiny:32,Mushroom:40,Flag:50,Start:51,Cloud:60,Hill:61,Bush:62,Castle:63},dl=new Set([Y.Ground,Y.Brick,Y.Question,Y.UsedBlock,Y.PipeTopL,Y.PipeTopR,Y.PipeBodyL,Y.PipeBodyR,Y.Ice,Y.Castle]),fl=new Set([Y.Spike,Y.Lava]),pl=new Set([Y.Platform,Y.Bridge]),ml=new Set([Y.PlatformH,Y.PlatformV]),hl=new Set([Y.Cloud,Y.Hill,Y.Bush]);Y.Goomba,Y.Koopa,Y.Spiny;function gl(e,t,n,r){t<0||n<0||t>=e.width||n>=e.height||(e.tiles[n*e.width+t]=r)}function _l(e){return{...e,tiles:[...e.tiles]}}function vl(e,t){let n=[];for(let r=0;r<e.height;r+=1)for(let i=0;i<e.width;i+=1)e.tiles[r*e.width+i]===t&&n.push({x:i,y:r});return n}function yl(e,t,n){return{x:e+.5,y:n-1-t+.5}}function bl(e,t,n){return{x:Math.floor(e),y:n-1-Math.floor(t)}}function xl(e){return JSON.stringify({id:e.id,name:e.name,theme:e.theme,timeLimit:e.timeLimit,width:e.width,height:e.height,tiles:e.tiles,author:e.author??`player`})}function Sl(e){let t=JSON.parse(e);if(!Array.isArray(t.tiles)||typeof t.width!=`number`)throw Error(`Invalid level payload`);return t}function X(e,t,n,r,i,a){for(let o=r;o<=i&&o<t;o+=1)o>=0&&(e[n*t+o]=a)}function Cl(e,t,n,r,i,a,o){for(let s=i;s<=a&&s<n;s+=1)s>=0&&r>=0&&r<t&&(e[s*t+r]=o)}function Z(e,t,n,r,i){e[r*t+n]=i}function wl(e,t){return Array(e*t).fill(Y.Empty)}function Tl(){let e=wl(64,16);X(e,64,15,0,63,Y.Ground),X(e,64,14,0,63,Y.Ground),Z(e,64,4,13,Y.Start);for(let[t,n]of[[10,12],[11,12],[12,11],[13,12],[14,12]])Z(e,64,t,n,Y.Coin);return Z(e,64,12,11,Y.Question),Z(e,64,13,11,Y.Brick),Z(e,64,14,11,Y.Question),Z(e,64,13,10,Y.Coin),Z(e,64,18,13,Y.Goomba),Z(e,64,28,13,Y.Goomba),X(e,64,15,30,32,Y.Empty),X(e,64,14,30,32,Y.Empty),Z(e,64,31,11,Y.PlatformH),Z(e,64,31,9,Y.Coin),X(e,64,13,22,24,Y.Ground),Z(e,64,22,12,Y.Coin),Z(e,64,24,12,Y.Coin),Z(e,64,34,13,Y.PipeTopL),Z(e,64,35,13,Y.PipeTopR),Z(e,64,34,14,Y.PipeBodyL),Z(e,64,35,14,Y.PipeBodyR),Z(e,64,34,13,Y.PipeTopL),Z(e,64,35,13,Y.PipeTopR),X(e,64,10,40,46,Y.Brick),Z(e,64,43,10,Y.Question),Z(e,64,43,9,Y.Coin),Z(e,64,48,13,Y.Goomba),Z(e,64,52,12,Y.Coin),Z(e,64,53,12,Y.Coin),Z(e,64,58,13,Y.Flag),Cl(e,64,16,58,9,12,Y.Empty),Z(e,64,58,13,Y.Flag),Z(e,64,58,12,Y.Empty),Z(e,64,57,13,Y.Coin),Z(e,64,8,13,Y.Bush),Z(e,64,30,13,Y.Bush),Z(e,64,20,13,Y.Hill),Z(e,64,45,13,Y.Hill),Z(e,64,15,3,Y.Cloud),Z(e,64,38,2,Y.Cloud),Z(e,64,50,4,Y.Cloud),{id:`demo-1`,name:`新手之路`,theme:`overworld`,timeLimit:120,width:64,height:16,tiles:e}}function El(){let e=wl(72,16);X(e,72,15,0,71,Y.Ground),X(e,72,14,0,71,Y.Ground),X(e,72,15,16,18,Y.Empty),X(e,72,14,16,18,Y.Empty),X(e,72,15,30,33,Y.Empty),X(e,72,14,30,33,Y.Empty),X(e,72,15,48,50,Y.Empty),X(e,72,14,48,50,Y.Empty),Z(e,72,3,13,Y.Start);for(let t=12;t<=14;t+=1)Z(e,72,t,12,Y.Coin);return Z(e,72,20,13,Y.Spring),Z(e,72,24,10,Y.Coin),Z(e,72,25,10,Y.Coin),Z(e,72,26,9,Y.Question),X(e,72,9,24,28,Y.Platform),Z(e,72,36,13,Y.PipeTopL),Z(e,72,37,13,Y.PipeTopR),Z(e,72,36,14,Y.PipeBodyL),Z(e,72,37,14,Y.PipeBodyR),Z(e,72,40,12,Y.PipeTopL),Z(e,72,41,12,Y.PipeTopR),Cl(e,72,16,40,13,14,Y.PipeBodyL),Cl(e,72,16,41,13,14,Y.PipeBodyR),Z(e,72,43,13,Y.Goomba),Z(e,72,45,13,Y.Goomba),Z(e,72,28,13,Y.Spring),Z(e,72,31,8,Y.Coin),Z(e,72,32,8,Y.Coin),X(e,72,11,31,32,Y.Brick),Z(e,72,46,13,Y.Spring),Z(e,72,52,11,Y.Coin),X(e,72,11,52,56,Y.Platform),Z(e,72,54,13,Y.Goomba),Z(e,72,49,10,Y.PlatformH),Z(e,72,49,7,Y.PlatformV),Z(e,72,60,13,Y.Spiny),Z(e,72,66,13,Y.Flag),Z(e,72,62,13,Y.Coin),Z(e,72,22,2,Y.Cloud),Z(e,72,44,3,Y.Cloud),Z(e,72,10,13,Y.Bush),Z(e,72,34,13,Y.Hill),{id:`demo-2`,name:`坑与弹簧`,theme:`overworld`,timeLimit:150,width:72,height:16,tiles:e}}function Dl(){let e=wl(80,16);X(e,80,15,0,79,Y.Ground),X(e,80,14,0,79,Y.Ground),Z(e,80,3,13,Y.Start),Z(e,80,12,13,Y.Goomba),Z(e,80,14,13,Y.Goomba),X(e,80,10,16,24,Y.Brick),Z(e,80,18,10,Y.Question),Z(e,80,21,10,Y.Question),Z(e,80,23,10,Y.Question),X(e,80,11,20,23,Y.Platform),Z(e,80,21,10,Y.Coin),Z(e,80,28,13,Y.Koopa),Z(e,80,36,13,Y.Goomba),Z(e,80,38,13,Y.Koopa),Z(e,80,32,13,Y.Spiny),Z(e,80,33,12,Y.Coin),Z(e,80,52,8,Y.PlatformH),X(e,80,13,42,44,Y.Ground),X(e,80,12,42,44,Y.Ground),Z(e,80,43,11,Y.Goomba),Z(e,80,42,11,Y.Coin),Z(e,80,44,11,Y.Coin),X(e,80,13,50,54,Y.Spike),X(e,80,10,48,56,Y.Platform);for(let t=49;t<=55;t+=2)Z(e,80,t,9,Y.Coin);return Z(e,80,58,13,Y.Koopa),Z(e,80,62,13,Y.Goomba),Z(e,80,64,13,Y.Goomba),X(e,80,11,66,70,Y.Brick),Z(e,80,68,11,Y.Question),Z(e,80,74,13,Y.Flag),Z(e,80,8,13,Y.Bush),Z(e,80,32,13,Y.Hill),Z(e,80,20,2,Y.Cloud),Z(e,80,50,3,Y.Cloud),Z(e,80,70,2,Y.Cloud),{id:`demo-3`,name:`敌阵走廊`,theme:`overworld`,timeLimit:160,width:80,height:16,tiles:e}}function Ol(){let e=wl(78,18);return X(e,78,17,0,77,Y.Ground),X(e,78,16,0,77,Y.Ground),Z(e,78,3,15,Y.Start),X(e,78,15,8,22,Y.Ice),Z(e,78,12,14,Y.Coin),Z(e,78,16,14,Y.Coin),Z(e,78,20,14,Y.Goomba),X(e,78,12,24,34,Y.Ice),X(e,78,11,24,34,Y.Empty),Cl(e,78,18,24,13,14,Y.Ground),Cl(e,78,18,34,13,14,Y.Ground),Z(e,78,22,15,Y.Spring),Z(e,78,28,11,Y.Coin),Z(e,78,30,11,Y.Coin),Z(e,78,32,11,Y.Koopa),X(e,78,17,36,38,Y.Empty),X(e,78,16,36,38,Y.Empty),X(e,78,15,36,38,Y.Empty),X(e,78,15,40,42,Y.Ice),Cl(e,78,18,40,16,16,Y.Ground),Cl(e,78,18,42,16,16,Y.Ground),X(e,78,15,45,47,Y.Ice),Cl(e,78,18,45,16,16,Y.Ground),Cl(e,78,18,47,16,16,Y.Ground),Z(e,78,41,14,Y.Coin),Z(e,78,46,14,Y.Coin),Z(e,78,50,15,Y.Spring),X(e,78,10,52,60,Y.Platform),Z(e,78,54,9,Y.Coin),Z(e,78,56,9,Y.Coin),Z(e,78,58,9,Y.Question),Z(e,78,56,15,Y.Goomba),Z(e,78,53,13,Y.PlatformV),Z(e,78,65,14,Y.Spiny),X(e,78,15,62,70,Y.Ice),Z(e,78,66,14,Y.Koopa),Z(e,78,72,15,Y.Flag),Z(e,78,14,2,Y.Cloud),Z(e,78,40,3,Y.Cloud),Z(e,78,58,2,Y.Cloud),Z(e,78,10,15,Y.Hill),Z(e,78,48,15,Y.Bush),{id:`demo-4`,name:`冰霜高台`,theme:`sky`,timeLimit:170,width:78,height:18,tiles:e}}function kl(){let e=wl(90,16);X(e,90,15,0,89,Y.Ground),X(e,90,14,0,89,Y.Ground),Z(e,90,3,13,Y.Start),X(e,90,13,10,12,Y.Spike),X(e,90,11,10,12,Y.Platform),Z(e,90,11,10,Y.Coin),Z(e,90,16,13,Y.Goomba),X(e,90,13,20,22,Y.Spike),X(e,90,10,18,24,Y.Brick),Z(e,90,21,10,Y.Question),Z(e,90,28,13,Y.PipeTopL),Z(e,90,29,13,Y.PipeTopR),Z(e,90,28,14,Y.PipeBodyL),Z(e,90,29,14,Y.PipeBodyR),Z(e,90,33,12,Y.PipeTopL),Z(e,90,34,12,Y.PipeTopR),Cl(e,90,16,33,13,14,Y.PipeBodyL),Cl(e,90,16,34,13,14,Y.PipeBodyR),Z(e,90,31,13,Y.Koopa),Z(e,90,37,13,Y.Goomba),X(e,90,15,40,43,Y.Empty),X(e,90,14,40,43,Y.Empty),Z(e,90,39,13,Y.Spring),X(e,90,9,40,44,Y.Platform),Z(e,90,41,8,Y.Coin),Z(e,90,42,8,Y.Coin),Z(e,90,43,8,Y.Coin),X(e,90,13,46,48,Y.Spike),Z(e,90,50,13,Y.Koopa),Z(e,90,52,13,Y.Koopa),Z(e,90,54,13,Y.Goomba),Z(e,90,56,13,Y.Spiny),Z(e,90,42,10,Y.PlatformH),Z(e,90,48,9,Y.PlatformV);for(let t=0;t<5;t+=1)Cl(e,90,16,58+t,13-t,14,Y.Ground);return Z(e,90,60,11,Y.Coin),Z(e,90,62,9,Y.Coin),X(e,90,13,66,72,Y.Lava),X(e,90,11,66,72,Y.Platform),X(e,90,8,66,72,Y.Platform),Z(e,90,68,10,Y.Goomba),Z(e,90,70,10,Y.Coin),Z(e,90,70,7,Y.Coin),Z(e,90,74,13,Y.Spring),Z(e,90,76,10,Y.Question),Z(e,90,78,13,Y.Goomba),Z(e,90,80,13,Y.Spiny),Z(e,90,81,11,Y.Coin),X(e,90,13,82,84,Y.Spike),X(e,90,10,82,84,Y.Platform),Z(e,90,86,13,Y.Flag),Z(e,90,14,2,Y.Cloud),Z(e,90,45,2,Y.Cloud),Z(e,90,70,3,Y.Cloud),Z(e,90,25,13,Y.Bush),{id:`demo-5`,name:`试炼工厂`,theme:`underground`,timeLimit:180,width:90,height:16,tiles:e}}var Al=[Tl(),El(),Dl(),Ol(),kl()];function jl(e){return Al.find(t=>t.id===e)}function Ml(e=`custom-1`,t=`自定义关卡`){let n=wl(80,16);return X(n,80,15,0,79,Y.Ground),X(n,80,14,0,79,Y.Ground),Z(n,80,3,13,Y.Start),Z(n,80,72,13,Y.Flag),{id:e,name:t,theme:`overworld`,timeLimit:150,width:80,height:16,tiles:n}}var Q={fixedDt:1/60,maxAccumulator:.1,gravity:34,maxFall:22,runSpeed:7.4,dashSpeed:11.2,accelGround:42,accelAir:28,frictionGround:30,frictionAir:4,iceFriction:3.5,iceAccel:18,jumpVel:12.4,doubleJumpVel:11.4,maxAirJumps:1,jumpCutMultiplier:.42,jumpCutDelay:.08,stompBounce:10.8,springVel:18.5,coyoteTime:.12,jumpBuffer:.15,groundSnapDist:.12,playerHalfW:.32,playerHalfH:.42,enemyHalfW:.34,enemyHalfH:.34,koopaHalfW:.32,koopaHalfH:.48,coinRadius:.28,bumpDuration:.16,deathHopVel:11,deathDuration:.9,clearDuration:1.1,hitstopSec:.04,walkAnimSpeed:8};function Nl(e,t){return Math.abs(e.x-t.x)<e.halfW+t.halfW&&Math.abs(e.y-t.y)<e.halfH+t.halfH}function Pl(e,t,n){return e<t?t:e>n?n:e}function Fl(e,t,n){return e<t?Math.min(e+n,t):Math.max(e-n,t)}function Il(e,t,n,r,i,a,o,s,c,l,u){let d={hitCeiling:!1,hitFloor:!1,hitWall:!1,ceilingTiles:[],onIce:!1};e.x+=t*r;let f=l(e.y-e.halfH+.001),p=l(e.y+e.halfH-.001),m=Math.min(f,p),h=Math.max(f,p);if(t>0)for(let t=m;t<=h;t+=1){let n=Math.floor(e.x+e.halfW);if(i(n,t)){e.x=n-e.halfW-1e-4,d.hitWall=!0;break}}else if(t<0)for(let t=m;t<=h;t+=1){let n=Math.floor(e.x-e.halfW);if(i(n,t)){e.x=n+1+e.halfW+1e-4,d.hitWall=!0;break}}let g=e.y-e.halfH;e.y+e.halfH,e.y+=n*r;let _=Math.floor(e.x-e.halfW+.02),v=Math.floor(e.x+e.halfW-.02);if(n>0){let t=l(e.y+e.halfH);for(let n=_;n<=v;n+=1)i(n,t)&&(e.y=c(t)-.5-e.halfH-1e-4,d.hitCeiling=!0,d.ceilingTiles.push({x:n,y:t}))}else if(n<0){let t=l(e.y-e.halfH);for(let r=_;r<=v;r+=1){let o=i(r,t),l=a(r,t);if(o||l){let i=c(t)+.5;if(l&&!o&&(g<i-.02||n>0))continue;e.y=i+e.halfH+1e-4,d.hitFloor=!0,(s(r,t)||o&&s(r,t))&&(d.onIce=!0),o&&s(r,t)&&(d.onIce=!0)}}}if(d.hitFloor){let t=l(e.y-e.halfH-.05);for(let e=_;e<=v;e+=1)s(e,t)&&(d.onIce=!0)}let y=u(e.x);return(o(y,l(e.y-e.halfH+.08))||o(y,l(e.y)))&&(d.hitFloor=d.hitFloor||!1),d}function Ll(e,t,n,r){let i=r(e.x-e.halfW+.05),a=r(e.x+e.halfW-.05),o=n(e.y-e.halfH+.05),s=n(e.y+e.halfH-.05);for(let e=i;e<=a;e+=1)for(let n=o;n<=s;n+=1)if(t(e,n))return!0;return!1}var Rl=class{group=new ln;body=new ln;velocity=new B;state=`idle`;onGround=!1;onIce=!1;facing=1;invulnerable=0;coyotePublic=0;jumpBufferPublic=0;airJumpsUsed=0;jumpHoldPublic=0;wasOnGround=!1;animTime=0;squash=1;bodyMesh;eyeL;eyeR;legL;legR;armL;armR;hat;deadTimer=0;constructor(){this.bodyMesh=this.buildBody(),this.body.add(this.bodyMesh),this.group.add(this.body),this.eyeL=this.bodyMesh.getObjectByName(`eyeL`),this.eyeR=this.bodyMesh.getObjectByName(`eyeR`),this.legL=this.bodyMesh.getObjectByName(`legL`),this.legR=this.bodyMesh.getObjectByName(`legR`),this.armL=this.bodyMesh.getObjectByName(`armL`),this.armR=this.bodyMesh.getObjectByName(`armR`),this.hat=this.bodyMesh.getObjectByName(`hat`)}get aabb(){return{x:this.group.position.x,y:this.group.position.y,halfW:Q.playerHalfW,halfH:Q.playerHalfH}}reset(e,t){this.group.position.set(e,t,0),this.velocity.set(0,0),this.state=`idle`,this.onGround=!1,this.onIce=!1,this.facing=1,this.invulnerable=0,this.coyotePublic=0,this.jumpBufferPublic=0,this.airJumpsUsed=0,this.jumpHoldPublic=0,this.wasOnGround=!1,this.deadTimer=0,this.squash=1,this.body.scale.set(1,1,1),this.body.rotation.z=0}kill(){this.state!==`dead`&&(this.state=`dead`,this.velocity.set(this.velocity.x*.4,Q.deathHopVel),this.deadTimer=Q.deathDuration)}get isDead(){return this.state===`dead`}get deadFinished(){return this.state===`dead`&&this.deadTimer<=0}markClear(){this.state=`clear`,this.velocity.x=Fl(this.velocity.x,0,20)}bounce(e=Q.stompBounce){this.velocity.y=e,this.onGround=!1,this.state=`stomp`}spring(e=Q.springVel){this.velocity.y=e,this.onGround=!1,this.state=`jump`,this.airJumpsUsed=0}bumpFromCeiling(){this.velocity.y=Math.min(this.velocity.y,-2),this.squash=.72}update(e,t,n,r){if(this.animTime+=e,this.invulnerable>0&&(this.invulnerable-=e),this.state===`dead`){this.deadTimer-=e,this.velocity.y-=Q.gravity*e,this.group.position.y+=this.velocity.y*e,this.group.position.x+=this.velocity.x*e,this.body.rotation.z+=e*6;return}if(this.state===`clear`){this.velocity.x=Fl(this.velocity.x,0,24*e),this.group.position.x+=this.velocity.x*e,this.applyVisual(e);return}if(!r){this.velocity.x=Fl(this.velocity.x,0,Q.frictionGround*e),this.applyVisual(e);return}n&&(this.onGround=n.hitFloor,this.onIce=n.onIce,n.hitCeiling&&this.bumpFromCeiling());let i=Pl(t.moveX,-1,1),a=t.dashHeld?Q.dashSpeed:Q.runSpeed,o=this.onIce?Q.iceAccel:this.onGround?Q.accelGround:Q.accelAir,s=this.onIce?Q.iceFriction:this.onGround?Q.frictionGround:Q.frictionAir;i===0?this.velocity.x=Fl(this.velocity.x,0,s*e):(this.velocity.x=Fl(this.velocity.x,i*a,o*e),this.facing=i>0?1:-1),this.onGround?this.coyotePublic=Q.coyoteTime:this.coyotePublic-=e,t.jumpPressed?this.jumpBufferPublic=Q.jumpBuffer:this.jumpBufferPublic-=e,this.jumpBufferPublic>0&&this.coyotePublic>0&&(this.velocity.y=Q.jumpVel,this.onGround=!1,this.coyotePublic=0,this.jumpBufferPublic=0,this.state=`jump`,this.squash=1.15),!t.jumpHeld&&this.velocity.y>0&&(this.velocity.y*=Q.jumpCutMultiplier),!this.onGround||this.velocity.y>0?(this.velocity.y-=Q.gravity*e,this.velocity.y<-Q.maxFall&&(this.velocity.y=-Q.maxFall)):this.velocity.y<0&&(this.velocity.y=0),this.state=this.velocity.y>.5&&!this.onGround?`jump`:this.velocity.y<-.5&&!this.onGround?`fall`:Math.abs(this.velocity.x)>.4?`run`:`idle`,this.applyVisual(e)}syncFromPhysics(e,t,n,r,i,a){this.group.position.set(e,t,0),this.velocity.set(n,r),this.onGround=i,this.onIce=a,this.state!==`dead`&&this.state!==`clear`&&(this.state=r>.6&&!i?`jump`:r<-.6&&!i?`fall`:Math.abs(n)>.4?`run`:`idle`,n>.2?this.facing=1:n<-.2&&(this.facing=-1))}frameVisual(e){if(this.animTime+=this.reducedAnim?0:e,this.invulnerable>0&&(this.invulnerable-=e),this.state===`dead`){this.deadTimer-=e,this.velocity.y-=Q.gravity*e,this.group.position.y+=this.velocity.y*e,this.group.position.x+=this.velocity.x*e,this.body.rotation.z+=e*6;return}this.applyVisual(e)}reducedAnim=!1;setReducedAnim(e){this.reducedAnim=e}stabilizeVisuals(){this.animTime=0,this.body.scale.set(1,1,1),this.body.rotation.z=0,this.group.rotation.y=0}applyVisual(e){this.group.rotation.y=this.facing>=0?0:Math.PI,this.squash=Fl(this.squash,1,4*e);let t=this.state===`run`?Math.abs(Math.sin(this.animTime*Q.walkAnimSpeed))*.06:0,n=this.state===`jump`?1.06:this.state===`fall`?.94:1;this.body.scale.set(1/Math.sqrt(this.squash),this.squash*n+t*.3,1),this.body.position.y=t;let r=this.state===`run`?Math.sin(this.animTime*Q.walkAnimSpeed)*.35:0;this.legL.rotation.x=r,this.legR.rotation.x=-r,this.armL.rotation.x=-r*.8,this.armR.rotation.x=r*.8,(this.state===`jump`||this.state===`fall`)&&(this.legL.rotation.x=.4,this.legR.rotation.x=-.25);let i=Math.sin(this.animTime*3.1)>.98?.2:1;this.eyeL.scale.y=i,this.eyeR.scale.y=i,this.state===`dead`&&(this.hat.position.y=.42+Math.sin(this.animTime*8)*.04)}buildBody(){let e=new ln,t=new K({color:`#e23d2e`,roughness:.55,metalness:.05}),n=new K({color:`#2f6fd0`,roughness:.6,metalness:.05}),r=new K({color:`#f0c49a`,roughness:.7}),i=new K({color:`#5a2d12`,roughness:.7}),a=new K({color:`#e23d2e`,roughness:.5}),o=new K({color:`#1a1a1a`,roughness:.4}),s=new K({color:`#f5d76e`,roughness:.4,metalness:.3}),c=new W(new G(.42,.32,.28),t);c.position.y=.08,e.add(c);let l=new W(new G(.4,.22,.26),n);l.position.y=-.08,e.add(l);let u=new W(new G(.34,.3,.3),r);u.position.y=.34,u.name=`head`,e.add(u);let d=new W(new G(.38,.12,.34),a);d.position.y=.52,d.name=`hat`,e.add(d);let f=new W(new G(.22,.05,.12),a);f.position.set(0,.46,.2),d.add(f);let p=new W(new G(.22,.06,.04),new K({color:`#2a1a10`}));p.position.set(0,.26,.16),e.add(p);let m=new G(.05,.08,.04),h=new W(m,o);h.position.set(-.07,.36,.16),h.name=`eyeL`;let g=new W(m,o);g.position.set(.07,.36,.16),g.name=`eyeR`,e.add(h,g);let _=new G(.14,.16,.16),v=new W(_,n);v.position.set(-.1,-.26,0),v.name=`legL`;let y=new W(_,n);y.position.set(.1,-.26,0),y.name=`legR`,e.add(v,y);let b=new G(.16,.08,.22),x=new W(b,i);x.position.set(0,-.1,.02),v.add(x);let S=new W(b,i);S.position.set(0,-.1,.02),y.add(S);let C=new G(.12,.22,.12),w=new W(C,t);w.position.set(-.28,.08,0),w.name=`armL`;let T=new W(C,t);T.position.set(.28,.08,0),T.name=`armR`,e.add(w,T);let E=new G(.12,.1,.12),D=new W(E,r);D.position.y=-.14,w.add(D);let ee=new W(E,r);ee.position.y=-.14,T.add(ee);let te=new W(new G(.06,.06,.04),s);te.position.set(-.1,0,.15);let O=te.clone();return O.position.x=.1,e.add(te,O),e.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),e}};function zl(e){return e===`goomba`||e===`koopa`}var Bl=class{group=new ln;velocity=new B;state=`walk`;kind;canStomp;facing=-1;squashedTimer=0;deadTimer=0;anim=0;inner=new ln;dangerRing=null;constructor(e,t,n){if(this.kind=e,this.canStomp=zl(e),this.group.position.set(t,n,0),this.group.add(this.inner),e===`goomba`?this.buildGoomba():e===`spiny`?this.buildSpiny():this.buildKoopa(),this.canStomp){let e=new W(new ki(.38,20),new Hr({color:`#3ecf8e`,transparent:!0,opacity:.35}));e.rotation.x=-Math.PI/2,e.position.y=-this.halfH+.03,this.group.add(e)}else{let e=new W(new Ni(.42,.52,24),new Hr({color:`#ff4d4d`,transparent:!0,opacity:.85,side:2}));e.rotation.x=-Math.PI/2,e.position.y=-this.halfH+.04,this.group.add(e),this.dangerRing=e}this.inner.traverse(e=>{let t=e;t.isMesh&&(t.castShadow=!0,t.receiveShadow=!0)})}get halfW(){return this.kind===`spiny`?.36:this.kind===`koopa`?Q.koopaHalfW:Q.enemyHalfW}get halfH(){return this.kind===`spiny`?.38:this.kind===`koopa`&&(this.state===`shell`||this.state===`shellSlide`)?.22:this.kind===`koopa`?Q.koopaHalfH:Q.enemyHalfH}get aabb(){return{x:this.group.position.x,y:this.group.position.y,halfW:this.halfW,halfH:this.halfH}}get speed(){return this.kind===`goomba`?1.65:this.kind===`spiny`?2.1:1.4}get alive(){return this.state!==`dead`&&!(this.state===`squashed`&&this.squashedTimer<=0)}squash(){if(this.canStomp){if(this.kind===`goomba`){if(this.state===`squashed`)return;this.state=`squashed`,this.squashedTimer=.5,this.velocity.x=0,this.inner.scale.y=.32,this.inner.scale.x=1.15;return}if(this.state===`walk`){this.state=`shell`,this.velocity.x=0,this.inner.scale.set(1,.72,1),this.inner.position.y=-.08;return}(this.state===`shell`||this.state===`shellSlide`)&&this.killFall()}}kickShell(e){this.kind===`koopa`&&this.state===`shell`&&(this.state=`shellSlide`,this.velocity.x=e*10.5,this.facing=e>=0?1:-1)}killFall(){this.state=`dead`,this.deadTimer=.85,this.velocity.y=9}get removed(){return this.state===`squashed`&&this.squashedTimer<=0||this.state===`dead`&&this.deadTimer<=0}update(e,t){if(this.anim+=e,this.dangerRing&&!this.removed){let e=.75+Math.sin(this.anim*6)*.2;this.dangerRing.scale.setScalar(e),this.dangerRing.material.opacity=.55+Math.sin(this.anim*6)*.25}if(this.state===`squashed`){this.squashedTimer-=e;return}if(this.state===`dead`){this.deadTimer-=e,this.velocity.y-=26*e,this.group.position.y+=this.velocity.y*e,this.group.position.x+=this.velocity.x*e,this.inner.rotation.z+=e*9;return}if(this.state===`walk`||this.state===`shellSlide`){t&&(this.facing*=-1);let e=this.state===`shellSlide`?10.5:this.speed;this.velocity.x=this.facing*e}else this.velocity.x=0;let n=this.state===`walk`?Math.sin(this.anim*10)*.03:0;this.inner.position.y=n,this.state===`shellSlide`&&(this.inner.rotation.z=this.anim*14)}stabilizeVisuals(){this.anim=0,this.inner.rotation.z=0}buildGoomba(){let e=new K({color:`#8b4518`,roughness:.7}),t=new K({color:`#d2a679`,roughness:.75}),n=new K({color:`#2b1a10`,roughness:.6}),r=new K({color:`#f7f3ea`,roughness:.4}),i=new K({color:`#111111`,roughness:.4}),a=new W(new Pi(.34,16,12),e);a.scale.y=.85,a.position.y=.05,this.inner.add(a);let o=new W(new G(.28,.18,.2),t);o.position.set(0,-.05,.18),this.inner.add(o);let s=new W(new G(.08,.1,.04),r);s.position.set(-.08,.08,.28);let c=s.clone();c.position.x=.08,this.inner.add(s,c);let l=new W(new G(.04,.05,.04),i);l.position.set(-.08,.08,.3);let u=l.clone();u.position.x=.08,this.inner.add(l,u);let d=new W(new G(.1,.03,.03),n);d.position.set(-.08,.16,.28),d.rotation.z=.3;let f=d.clone();f.position.x=.08,f.rotation.z=-.3,this.inner.add(d,f);let p=new G(.16,.1,.22),m=new W(p,n);m.position.set(-.14,-.28,.04);let h=new W(p,n);h.position.set(.14,-.28,.04),this.inner.add(m,h);let g=new W(new Pi(.08,8,8),new Hr({color:`#3ecf8e`}));g.position.set(0,.42,0),this.inner.add(g)}buildSpiny(){let e=new K({color:`#5c1a2e`,roughness:.55}),t=new K({color:`#c23b2e`,roughness:.4,metalness:.15}),n=new K({color:`#f0d060`,roughness:.35,metalness:.25,emissive:`#664400`,emissiveIntensity:.35}),r=new K({color:`#ff6b6b`,roughness:.4,emissive:`#550000`,emissiveIntensity:.4}),i=new W(new Pi(.32,16,12),e);i.scale.y=.8,i.position.y=.02,this.inner.add(i);let a=new W(new Pi(.28,14,10),t);a.scale.y=.7,a.position.y=.12,this.inner.add(a);let o=new ji(.08,.28,6);for(let[e,t,r]of[[0,.34,0],[-.16,.28,.08],[.16,.28,.08],[-.12,.26,-.14],[.12,.26,-.14],[0,.22,.18]]){let i=new W(o,n);i.position.set(e,t,r),i.rotation.x=r>0?.4:r<0?-.35:0,this.inner.add(i)}let s=new W(new G(.07,.08,.04),r);s.position.set(-.08,.08,.28);let c=s.clone();c.position.x=.08,this.inner.add(s,c);let l=new G(.14,.1,.18),u=new K({color:`#3a1020`,roughness:.7}),d=new W(l,u);d.position.set(-.14,-.26,.02);let f=new W(l,u);f.position.set(.14,-.26,.02),this.inner.add(d,f)}buildKoopa(){let e=new K({color:`#2f9e44`,roughness:.45,metalness:.08}),t=new K({color:`#f0e6a8`,roughness:.55}),n=new K({color:`#f2d49a`,roughness:.7}),r=new K({color:`#ffffff`,roughness:.4}),i=new K({color:`#111111`,roughness:.4}),a=new K({color:`#1e3d24`,roughness:.55}),o=new W(new Pi(.32,16,12),e);o.scale.set(1,1.05,.85),o.position.set(0,.02,-.08),o.name=`shell`,this.inner.add(o);let s=new W(new Fi(.28,.05,8,20),t);s.rotation.x=Math.PI/2,s.position.set(0,.02,-.08),this.inner.add(s);let c=new W(new Pi(.18,12,10),n);c.position.set(0,.22,.22),this.inner.add(c);let l=new W(new G(.14,.1,.12),n);l.position.set(0,.18,.36),this.inner.add(l);let u=new W(new G(.06,.08,.04),r);u.position.set(-.08,.28,.32);let d=u.clone();d.position.x=.08,this.inner.add(u,d);let f=new W(new G(.03,.04,.04),i);f.position.set(-.08,.28,.34);let p=f.clone();p.position.x=.08,this.inner.add(f,p);let m=new G(.14,.12,.2),h=new W(m,n);h.position.set(-.14,-.32,.08);let g=new W(m,n);g.position.set(.14,-.32,.08),this.inner.add(h,g);let _=new W(new G(.2,.04,.04),a);_.position.set(0,.12,-.32),this.inner.add(_);let v=new W(new Pi(.08,8,8),new Hr({color:`#3ecf8e`}));v.position.set(0,.48,0),this.inner.add(v)}},Vl=class{axis;range;speed;group=new ln;velocity=new B;baseX;baseY;t;prevX;prevY;constructor(e,t,n,r=3.2,i=1.4,a=0){this.axis=n,this.range=r,this.speed=i,this.baseX=e,this.baseY=t,this.t=a,this.prevX=e,this.prevY=t,this.build(),this.group.position.set(e,t,0)}get halfW(){return .72}get halfH(){return .16}get aabb(){return{x:this.group.position.x,y:this.group.position.y,halfW:this.halfW,halfH:this.halfH}}get topY(){return this.group.position.y+this.halfH}update(e,t){t||(this.t+=e*this.speed);let n=Math.sin(this.t),r=this.axis===`h`?this.baseX+n*this.range:this.baseX,i=this.axis===`v`?this.baseY+n*this.range:this.baseY;this.velocity.set((r-this.prevX)/Math.max(e,1e-6),(i-this.prevY)/Math.max(e,1e-6)),this.prevX=r,this.prevY=i,this.group.position.set(r,i,0)}stabilizeVisuals(){this.group.position.set(this.baseX,this.baseY,0),this.velocity.set(0,0)}tryLand(e,t,n){if(n>.5)return!1;let r=this.aabb;if(!(Math.abs(e.x-r.x)<e.halfW+r.halfW-.02))return!1;let i=this.topY,a=e.y-e.halfH;return a<=i+.18&&t>=i-.25||a<=i+.08&&Math.abs(a-i)<.2}isStandingOn(e){let t=e.y-e.halfH;return Math.abs(e.x-this.group.position.x)<e.halfW+this.halfW-.02&&Math.abs(t-this.topY)<.16}build(){let e=new K({color:`#d4b56a`,roughness:.55,metalness:.15}),t=new K({color:`#3d7ea6`,roughness:.45,metalness:.2}),n=new K({color:`#7ec8f0`,emissive:`#2a6a90`,emissiveIntensity:.45,roughness:.4}),r=new W(new G(1.4,.22,.9),e);r.castShadow=!0,r.receiveShadow=!0,this.group.add(r);for(let e of[-.45,.45]){let n=new W(new G(.22,.26,.92),t);n.position.x=e,this.group.add(n)}let i=new W(new ji(.12,.22,3),n);this.axis===`h`?(i.position.set(.78,0,0),i.rotation.z=-Math.PI/2):i.position.set(0,.28,0),this.group.add(i);let a=new W(new G(1.2,.08,.7),n);a.position.y=-.14,this.group.add(a)}},Hl=class{group=new ln;kind;active=!0;velocity=new B;anim;baseY;timer=0;constructor(e,t,n,r=0){this.kind=e,this.group.position.set(t,n,0),this.baseY=n,this.anim=r,e===`mushroom`?this.buildMushroom():this.buildCoin()}update(e,t){if(this.active||this.kind===`coinPop`){if(t||(this.anim+=e),this.kind===`coin`){this.group.rotation.y=this.anim*3,this.group.position.y=this.baseY+Math.sin(this.anim*2.4)*.08;let e=.85+Math.abs(Math.sin(this.anim*3))*.25;this.group.scale.set(e,1,1);return}if(this.kind===`mushroom`){this.timer+=e,this.group.position.x+=this.velocity.x*e,this.group.position.y+=this.velocity.y*e,this.velocity.y-=28*e,this.group.rotation.y=Math.sin(this.anim*4)*.15;return}if(this.kind===`coinPop`){this.timer+=e,this.group.position.y+=e*4.5,this.group.rotation.y+=e*10;let t=1-this.timer/.45;this.group.scale.setScalar(Math.max(0,t)),this.timer>.45&&(this.active=!1)}}}get finished(){return!this.active}collect(){this.active=!1,this.group.visible=!1}stabilizeVisuals(){this.anim=0,this.group.rotation.y=0,this.group.position.y=this.baseY}buildCoin(){let e=new K({color:`#f5c542`,metalness:.65,roughness:.28,emissive:`#6a4a00`,emissiveIntensity:.25}),t=new W(new Ai(.22,.22,.08,20),e);t.rotation.z=Math.PI/2,t.castShadow=!0,this.group.add(t);let n=new W(new Fi(.16,.03,8,16),new K({color:`#ffe08a`,metalness:.7,roughness:.25}));n.rotation.y=Math.PI/2,this.group.add(n)}buildMushroom(){let e=new K({color:`#e23d2e`,roughness:.5}),t=new K({color:`#f6f1df`,roughness:.55}),n=new K({color:`#f0d5a8`,roughness:.7}),r=new W(new Pi(.28,16,12,0,Math.PI*2,0,Math.PI/2),e);r.position.y=.08,r.castShadow=!0,this.group.add(r);for(let[e,n]of[[-.12,.1],[.12,.08],[0,-.12]]){let r=new W(new Pi(.07,8,8),t);r.position.set(e,.22,n),this.group.add(r)}let i=new W(new Ai(.14,.16,.22,12),n);i.position.y=-.08,i.castShadow=!0,this.group.add(i)}};function Ul(e,t){return new Hl(`coinPop`,e,t,0)}var $={C3:130.81,D3:146.83,E3:164.81,F3:174.61,G3:196,A3:220,B3:246.94,C4:261.63,D4:293.66,E4:329.63,F4:349.23,G4:392,A4:440,B4:493.88,C5:523.25,D5:587.33,E5:659.25,F5:698.46,G5:783.99,A5:880,Ab3:207.65,Eb4:311.13,Bb3:233.08},Wl={menu:{bpm:112,mood:`soft`,hat:!1,melody:[{f:$.E5,t:0,d:.5},{f:$.G5,t:.5,d:.5},{f:$.A5,t:1,d:1},{f:$.G5,t:2,d:.5},{f:$.E5,t:2.5,d:.5},{f:$.D5,t:3,d:1},{f:$.C5,t:4,d:.5},{f:$.E5,t:4.5,d:.5},{f:$.G5,t:5,d:1},{f:$.E5,t:6,d:.5},{f:$.D5,t:6.5,d:.5},{f:$.C5,t:7,d:1}],bass:[{f:$.C3,t:0,d:1},{f:$.G3,t:1,d:1},{f:$.A3,t:2,d:1},{f:$.G3,t:3,d:1},{f:$.F3,t:4,d:1},{f:$.C3,t:5,d:1},{f:$.G3,t:6,d:1},{f:$.C3,t:7,d:1}]},play:{bpm:132,mood:`bright`,hat:!0,melody:[{f:$.C5,t:0,d:.4},{f:$.E5,t:.5,d:.4},{f:$.G5,t:1,d:.4},{f:$.E5,t:1.5,d:.4},{f:$.C5,t:2,d:.4},{f:$.G4,t:2.5,d:.4},{f:$.A4,t:3,d:.8},{f:$.D5,t:4,d:.4},{f:$.F5,t:4.5,d:.4},{f:$.A5,t:5,d:.4},{f:$.F5,t:5.5,d:.4},{f:$.D5,t:6,d:.4},{f:$.A4,t:6.5,d:.4},{f:$.G4,t:7,d:.8},{f:$.E5,t:8,d:.4},{f:$.G5,t:8.5,d:.4},{f:$.C5,t:9,d:.4},{f:$.E5,t:9.5,d:.4},{f:$.G4,t:10,d:.4},{f:$.C5,t:10.5,d:.4},{f:$.E4,t:11,d:.8},{f:$.F4,t:12,d:.4},{f:$.A4,t:12.5,d:.4},{f:$.C5,t:13,d:.4},{f:$.A4,t:13.5,d:.4},{f:$.G4,t:14,d:.4},{f:$.D5,t:14.5,d:.4},{f:$.C5,t:15,d:1.2}],bass:[{f:$.C3,t:0,d:.9},{f:$.C3,t:1,d:.4},{f:$.G3,t:1.5,d:.4},{f:$.C3,t:2,d:.9},{f:$.E3,t:3,d:.9},{f:$.D3,t:4,d:.9},{f:$.D3,t:5,d:.4},{f:$.A3,t:5.5,d:.4},{f:$.D3,t:6,d:.9},{f:$.G3,t:7,d:.9},{f:$.E3,t:8,d:.9},{f:$.C3,t:9,d:.9},{f:$.F3,t:10,d:.9},{f:$.C3,t:11,d:.9},{f:$.F3,t:12,d:.9},{f:$.A3,t:13,d:.9},{f:$.G3,t:14,d:.9},{f:$.C3,t:15,d:.9}]},underground:{bpm:118,mood:`dark`,hat:!0,melody:[{f:$.A3,t:0,d:.5},{f:$.C4,t:.5,d:.5},{f:$.Eb4,t:1,d:.5},{f:$.A3,t:1.5,d:.5},{f:$.Ab3,t:2,d:.8},{f:$.C4,t:3,d:.8},{f:$.G3,t:4,d:.5},{f:$.Bb3,t:4.5,d:.5},{f:$.D4,t:5,d:.5},{f:$.G3,t:5.5,d:.5},{f:$.A3,t:6,d:.8},{f:$.C4,t:7,d:.8},{f:$.Eb4,t:8,d:.4},{f:$.D4,t:8.5,d:.4},{f:$.C4,t:9,d:.4},{f:$.A3,t:9.5,d:.4},{f:$.Ab3,t:10,d:.9},{f:$.A3,t:11,d:.9},{f:$.D4,t:12,d:.4},{f:$.C4,t:12.5,d:.4},{f:$.Bb3,t:13,d:.4},{f:$.G3,t:13.5,d:.4},{f:$.A3,t:14,d:1.5}],bass:[{f:$.A3/2,t:0,d:.45},{f:$.A3/2,t:.5,d:.45},{f:$.A3/2,t:1,d:.45},{f:$.A3/2,t:1.5,d:.45},{f:$.Ab3/2,t:2,d:.9},{f:$.Ab3/2,t:3,d:.9},{f:$.G3/2,t:4,d:.45},{f:$.G3/2,t:4.5,d:.45},{f:$.G3/2,t:5,d:.45},{f:$.G3/2,t:5.5,d:.45},{f:$.A3/2,t:6,d:.9},{f:$.C3,t:7,d:.9},{f:$.Eb4/2,t:8,d:.45},{f:$.Eb4/2,t:8.5,d:.45},{f:$.C3,t:9,d:.9},{f:$.Ab3/2,t:10,d:.9},{f:$.A3/2,t:11,d:.9},{f:$.D3,t:12,d:.9},{f:$.G3/2,t:13,d:.9},{f:$.A3/2,t:14,d:1.5}]},editor:{bpm:100,mood:`soft`,hat:!1,melody:[{f:$.G4,t:0,d:.6},{f:$.B4,t:1,d:.6},{f:$.D5,t:2,d:.9},{f:$.E5,t:3,d:.6},{f:$.D5,t:4,d:.6},{f:$.B4,t:5,d:.6},{f:$.A4,t:6,d:.9},{f:$.G4,t:7,d:.9},{f:$.E4,t:8,d:.6},{f:$.G4,t:9,d:.6},{f:$.A4,t:10,d:.9},{f:$.B4,t:11,d:.6},{f:$.C5,t:12,d:.6},{f:$.B4,t:13,d:.6},{f:$.A4,t:14,d:1.2}],bass:[{f:$.G3,t:0,d:1.4},{f:$.D3,t:2,d:1.4},{f:$.E3,t:4,d:1.4},{f:$.B3,t:6,d:1.4},{f:$.C3,t:8,d:1.4},{f:$.A3,t:10,d:1.4},{f:$.D3,t:12,d:1.4},{f:$.G3,t:14,d:1.4}]},clear:{bpm:140,mood:`bright`,hat:!0,melody:[{f:$.C5,t:0,d:.35},{f:$.E5,t:.5,d:.35},{f:$.G5,t:1,d:.35},{f:$.C5*2,t:1.5,d:.9},{f:$.G5,t:3,d:.35},{f:$.E5,t:3.5,d:.35},{f:$.C5,t:4,d:1.2}],bass:[{f:$.C3,t:0,d:.9},{f:$.G3,t:1,d:.9},{f:$.C3,t:2,d:.9},{f:$.G3,t:3,d:.9},{f:$.C3,t:4,d:1.2}]},fail:{bpm:90,mood:`dark`,hat:!1,melody:[{f:$.A3,t:0,d:.4},{f:$.F3,t:.5,d:.4},{f:$.D3,t:1,d:.4},{f:$.A3/2,t:1.5,d:1.4}],bass:[{f:$.A3/2,t:0,d:2.8}]}},Gl=class{ctx=null;master=null;sfxBus=null;bgmBus=null;muted=!1;bgmTrack=`none`;bgmGain=.16;sfxGain=.28;timer=null;nextScheduleTime=0;get currentBgm(){return this.bgmTrack}get isMuted(){return this.muted}unlock(){if(!this.ctx){let e=window.AudioContext??window.webkitAudioContext;if(!e)return;this.ctx=new e,this.master=this.ctx.createGain(),this.master.gain.value=+!this.muted,this.master.connect(this.ctx.destination),this.sfxBus=this.ctx.createGain(),this.sfxBus.gain.value=this.sfxGain,this.sfxBus.connect(this.master),this.bgmBus=this.ctx.createGain(),this.bgmBus.gain.value=0,this.bgmBus.connect(this.master)}this.ctx.state===`suspended`&&this.ctx.resume()}setMuted(e){this.muted=e,this.master&&(this.master.gain.value=+!e)}toggleMute(){return this.setMuted(!this.muted),this.muted}playBgm(e){if(this.bgmTrack===e)return;this.bgmTrack=e,this.unlock();let t=this.ctx,n=this.bgmBus;if(!t||!n)return;this.stopScheduler();let r=t.currentTime;n.gain.cancelScheduledValues(r),n.gain.setValueAtTime(Math.max(1e-4,n.gain.value),r),n.gain.linearRampToValueAtTime(1e-4,r+.2),e!==`none`&&window.setTimeout(()=>{if(this.bgmTrack!==e||!this.ctx||!this.bgmBus)return;let t=this.ctx;this.nextScheduleTime=t.currentTime+.05;let n=Wl[e],r=Math.max(...n.melody.map(e=>e.t+e.d),...n.bass.map(e=>e.t+e.d),8);this.bgmBus.gain.cancelScheduledValues(t.currentTime),this.bgmBus.gain.setValueAtTime(1e-4,t.currentTime),this.bgmBus.gain.linearRampToValueAtTime(this.bgmGain,t.currentTime+.35),this.scheduleAhead(r),this.timer=window.setInterval(()=>this.scheduleAhead(r),120)},210)}stopBgm(){this.playBgm(`none`)}duckBgm(e=.55,t=.25){let n=this.ctx,r=this.bgmBus;if(!n||!r||this.bgmTrack===`none`)return;let i=n.currentTime,a=this.bgmGain*e;r.gain.cancelScheduledValues(i),r.gain.setValueAtTime(r.gain.value,i),r.gain.linearRampToValueAtTime(Math.max(1e-4,a),i+.04),r.gain.linearRampToValueAtTime(this.bgmGain,i+t)}jump(){this.blip(420,720,.12,`square`,.2)}coin(){this.blip(880,1320,.1,`square`,.15),window.setTimeout(()=>this.blip(1320,1600,.08,`square`,.12),40)}stomp(){this.blip(300,90,.12,`triangle`,.28)}bump(){this.blip(180,120,.08,`square`,.2)}breakBrick(){this.noise(.12,.25)}spring(){this.blip(220,900,.2,`sine`,.25)}die(){this.blip(400,80,.45,`sawtooth`,.22)}clear(){[523,659,784,1046].forEach((e,t)=>{window.setTimeout(()=>this.blip(e,e*1.02,.14,`square`,.16),t*90)})}ui(){this.blip(600,780,.06,`square`,.1)}place(){this.blip(500,420,.05,`triangle`,.12)}dispose(){this.stopScheduler(),this.bgmTrack=`none`,this.ctx&&(this.ctx.close(),this.ctx=null,this.master=null,this.sfxBus=null,this.bgmBus=null)}stopScheduler(){this.timer!==null&&(window.clearInterval(this.timer),this.timer=null)}scheduleAhead(e){let t=this.ctx,n=this.bgmBus,r=this.bgmTrack;if(!t||!n||r===`none`)return;let i=Wl[r],a=60/i.bpm,o=t.currentTime+.45;for(;this.nextScheduleTime<o;){let t=this.nextScheduleTime;this.schedulePattern(i.melody,t,a,n,`square`,.22,i.mood),this.schedulePattern(i.bass,t,a,n,`triangle`,.3,i.mood),i.hat&&this.scheduleHats(t,a,e,n),this.nextScheduleTime+=e*a}}schedulePattern(e,t,n,r,i,a,o){if(this.ctx)for(let s of e){let e=t+s.t*n,c=Math.max(.05,s.d*n*.92),l=a*(s.v??1)*(o===`soft`?.7:1);this.scheduleNote(s.f,e,c,i,l,r,o)}}scheduleNote(e,t,n,r,i,a,o){let s=this.ctx;if(!s)return;let c=s.createOscillator(),l=s.createGain(),u=s.createBiquadFilter();u.type=`lowpass`,u.frequency.value=o===`dark`?900:2400,c.type=r,c.frequency.setValueAtTime(e,t),o===`bright`&&c.detune.setValueAtTime(4,t),l.gain.setValueAtTime(1e-4,t),l.gain.linearRampToValueAtTime(i,t+.02),l.gain.setValueAtTime(i,t+Math.max(.02,n-.06)),l.gain.exponentialRampToValueAtTime(1e-4,t+n+.03),c.connect(u),u.connect(l),l.connect(a),c.start(t),c.stop(t+n+.05)}scheduleHats(e,t,n,r){let i=this.ctx;if(i)for(let a=0;a<n;a+=.5){let n=e+a*t,o=Math.floor(i.sampleRate*.03);if(o<=0)continue;let s=i.createBuffer(1,o,i.sampleRate),c=s.getChannelData(0);for(let e=0;e<o;e+=1)c[e]=(Math.random()*2-1)*(1-e/o);let l=i.createBufferSource();l.buffer=s;let u=i.createBiquadFilter();u.type=`highpass`,u.frequency.value=5e3;let d=i.createGain(),f=a%1==0?.045:.028;d.gain.value=f,l.connect(u),u.connect(d),d.connect(r),l.start(n)}}blip(e,t,n,r,i){if(this.muted)return;this.unlock();let a=this.ctx,o=this.sfxBus??this.master;if(!a||!o)return;let s=a.currentTime,c=a.createOscillator(),l=a.createGain();c.type=r,c.frequency.setValueAtTime(e,s),c.frequency.exponentialRampToValueAtTime(Math.max(40,t),s+n),l.gain.setValueAtTime(i,s),l.gain.exponentialRampToValueAtTime(.001,s+n),c.connect(l),l.connect(o),c.start(s),c.stop(s+n+.02)}noise(e,t){if(this.muted)return;this.unlock();let n=this.ctx,r=this.sfxBus??this.master;if(!n||!r)return;let i=Math.floor(n.sampleRate*e),a=n.createBuffer(1,i,n.sampleRate),o=a.getChannelData(0);for(let e=0;e<i;e+=1)o[e]=(Math.random()*2-1)*(1-e/i);let s=n.createBufferSource();s.buffer=a;let c=n.createGain();c.gain.value=t,s.connect(c),c.connect(r),s.start()}},Kl=class{group=new ln;camX=0;constructor(e){let t=this.makeRidge(5941354,8,2.2,40),n=this.makeRidge(4165461,6,1.6,28);if(t.position.z=-8,n.position.z=-5,t.userData.parallax=.25,n.userData.parallax=.45,e===`underground`||e===`castle`){t.visible=!1,n.visible=!1;let e=this.makeCave();e.position.z=-9,e.userData.parallax=.15,this.group.add(e)}this.group.add(t,n);let r=new Hr({color:e===`underground`?`#cfd8ff`:`#fff3b0`}),i=new W(new ki(1.6,24),r);i.position.set(0,0,-12),i.userData.parallax=.1,this.group.add(i)}update(e,t){this.camX=e;for(let e of this.group.children){let t=e.userData.parallax??0;e.position.x=this.camX*t,e.userData.keepCenter&&(e.position.x=this.camX*.05)}}makeRidge(e,t,n,r){let i=new Mi(r,n,t,1),a=i.attributes.position;for(let e=0;e<a.count;e+=1){let t=a.getX(e),n=a.getY(e);n>0&&a.setY(e,n+Math.sin(t*.7)*.6+Math.cos(t*.3)*.4)}a.needsUpdate=!0;let o=new W(i,new Hr({color:e}));return o.position.y=2.2,o}makeCave(){return new W(new Mi(60,20),new Hr({color:`#243044`}))}},ql=1.5,Jl=.45;function Yl(e,t){let n=Math.sin(e*12.9898+t*78.233)*43758.5453;return(n-Math.floor(n))*2-1}var Xl=class{camera;viewHeight;trauma=0;shakeTime=0;camX=0;camY=0;halfW=10;halfH=6;constructor(e,t=12){this.camera=e,this.viewHeight=t,this.applyProjection(1)}applyProjection(e){let t=this.viewHeight,n=t*e;this.halfW=n/2,this.halfH=t/2,this.camera.left=-this.halfW,this.camera.right=this.halfW,this.camera.top=this.halfH,this.camera.bottom=-this.halfH,this.camera.near=-50,this.camera.far=50,this.camera.updateProjectionMatrix()}snapTo(e,t,n,r){this.camX=this.clampX(e,n),this.camY=this.clampY(t,r),this.camera.position.set(this.camX,this.camY,20),this.camera.lookAt(this.camX,this.camY,0)}update(e,t,n,r,i){let a=this.clampX(t+1.2,r),o=this.clampY(n+.8,i),s=1-.001**e;this.camX+=(a-this.camX)*s,this.camY+=(o-this.camY)*s,this.shakeTime+=e,this.trauma=Math.max(0,this.trauma-ql*e);let c=this.trauma*this.trauma,l=Jl*c*Yl(this.shakeTime*30,1),u=Jl*c*Yl(this.shakeTime*30,2);this.camera.position.set(this.camX+l,this.camY+u,20),this.camera.lookAt(this.camX+l,this.camY+u,0)}addTrauma(e){this.trauma=Math.min(1,this.trauma+e)}get viewBounds(){return{left:this.camX-this.halfW,right:this.camX+this.halfW,top:this.camY+this.halfH,bottom:this.camY-this.halfH,halfW:this.halfW,halfH:this.halfH,x:this.camX,y:this.camY}}screenToWorld(e,t,n,r){let i=e/n,a=t/r;return{x:this.camX+(i-.5)*this.halfW*2,y:this.camY+(.5-a)*this.halfH*2}}clampX(e,t){let n=this.halfW,r=Math.max(n,t-this.halfW);return Math.min(r,Math.max(n,e))}clampY(e,t){let n=this.halfH-.5,r=Math.max(n,t-this.halfH+.5);return Math.min(r,Math.max(n,e))}},Zl={overworld:`#7ec8f0`,underground:`#1a2030`,sky:`#9ad7ff`,castle:`#3a2a2a`},Ql={overworld:`#7ec8f0`,underground:`#151a28`,sky:`#b6e4ff`,castle:`#2a2020`};function $l(e){return{solid:dl.has(e),oneWay:pl.has(e),hazard:fl.has(e),ice:e===Y.Ice,bumpable:e===Y.Question||e===Y.Brick,breakable:e===Y.Brick,spring:e===Y.Spring,entity:e===Y.Coin||e===Y.Goomba||e===Y.Koopa||e===Y.Mushroom||e===Y.Flag||e===Y.Start}}var eu=class{group=new ln;staticGroup=new ln;decorGroup=new ln;flagGroup=new ln;dynamicGroup=new ln;materials=new Map;geos=[];bumpMeshes=new Map;gridHelper=null;showGrid=!1;showEntityGhosts=!1;setTheme(e,t){t.background=new U(Zl[e.theme]??Zl.overworld),t.fog=new _n(Ql[e.theme]??Ql.overworld,28,70)}rebuild(e){this.clearGroup(this.staticGroup),this.clearGroup(this.decorGroup),this.clearGroup(this.flagGroup),this.bumpMeshes.clear();let t=this.getGeo(new G(.98,.98,.98)),n=this.getGeo(new G(.98,.28,.9));for(let r=0;r<e.height;r+=1)for(let i=0;i<e.width;i+=1){let a=e.tiles[r*e.width+i];if(a===Y.Empty||a===Y.Start)continue;let o=yl(i,r,e.height);if(hl.has(a)||a===Y.Hill){let e=this.makeDeco(a);e&&(e.position.set(o.x,this.decoY(a,o.y),0),this.decorGroup.add(e));continue}if(a===Y.Flag){let e=this.makeFlag();e.position.set(o.x,o.y-.2,0),this.flagGroup.add(e);continue}if(ml.has(a)){if(this.showEntityGhosts){let e=this.makeMovingGhost(a===Y.PlatformH?`h`:`v`);e.position.set(o.x,o.y,0),this.staticGroup.add(e)}continue}if(a===Y.Goomba||a===Y.Koopa||a===Y.Spiny||a===Y.Coin||a===Y.Mushroom){if(this.showEntityGhosts){let e=this.makeEntityGhost(a);e.position.set(o.x,o.y,0),this.staticGroup.add(e)}continue}if($l(a).entity)continue;let s=this.makeTileMesh(a,a===Y.Platform||a===Y.Bridge?n:t);s&&(s.position.set(o.x,o.y,0),a===Y.Spring&&(s.position.y=o.y-.25),a===Y.Spike&&(s.position.y=o.y-.22),this.staticGroup.add(s),$l(a).bumpable&&this.bumpMeshes.set(`${i},${r}`,s))}this.showGrid&&this.buildGrid(e),this.group.add(this.staticGroup,this.decorGroup,this.flagGroup,this.dynamicGroup)}getBumpMesh(e,t){return this.bumpMeshes.get(`${e},${t}`)}setGridVisible(e,t){this.showGrid=t,this.gridHelper&&=(this.group.remove(this.gridHelper),this.gridHelper.geometry.dispose(),this.gridHelper.material.dispose(),null),t&&this.buildGrid(e)}buildGrid(e){let t=[],n=e.height;for(let r=0;r<=e.width;r+=1)t.push(r,0,0,r,n,0);for(let r=0;r<=n;r+=1)t.push(0,r,0,e.width,r,0);let r=new fr;r.setAttribute(`position`,new er(t,3));let i=new di({color:`#ffffff`,transparent:!0,opacity:.18});this.gridHelper=new Ci(r,i),this.gridHelper.position.y=0;let a=[];for(let t=0;t<=e.width;t+=1)a.push(t,0,0,t,e.height,0);for(let t=0;t<=e.height;t+=1)a.push(0,t,0,e.width,t,0);r.setAttribute(`position`,new er(a,3)),this.group.add(this.gridHelper)}dispose(){this.clearGroup(this.group),this.clearGroup(this.staticGroup),this.clearGroup(this.decorGroup),this.clearGroup(this.flagGroup),this.clearGroup(this.dynamicGroup);for(let e of this.geos)e.dispose();for(let e of this.materials.values())e.dispose();this.geos=[],this.materials.clear()}clearGroup(e){for(;e.children.length;){let t=e.children[0];e.remove(t),t.traverse(e=>{let t=e;t.isMesh&&t.geometry&&this.geos.includes(t.geometry)})}}getGeo(e){return this.geos.push(e),e}getMat(e,t){let n=this.materials.get(tu(e));return n||(n=t(),this.materials.set(tu(e),n)),n}makeTileMesh(e,t){let n=this.materialFor(e);if(!n)return null;let r=new W(t,n);if(r.castShadow=e!==Y.Platform&&e!==Y.Bridge,r.receiveShadow=!0,e===Y.Question){let e=this.makeLabelSprite(`?`);e.position.set(0,0,.55),e.scale.set(.7,.7,.7),r.add(e)}if(e===Y.Spring){let e=new W(this.getGeo(new G(.95,.18,.95)),this.getMat(`spring-top`,()=>new K({color:`#e8f0ff`,roughness:.4,metalness:.2})));e.position.y=.35,r.add(e)}return r}materialFor(e){let t=(t,n=.7,r=.04,i,a=0)=>this.getMat(`t${e}${t}${n}${i??``}`,()=>{let e={color:t,roughness:n,metalness:r};return i&&(e.emissive=i,e.emissiveIntensity=a),new K(e)});switch(e){case Y.Ground:return t(`#c47a3a`,.85);case Y.Brick:return t(`#b85c38`,.8);case Y.Question:return t(`#e8b13a`,.45,.2,`#6a4a00`,.2);case Y.UsedBlock:return t(`#8a6a48`,.85);case Y.PipeTopL:case Y.PipeTopR:case Y.PipeBodyL:case Y.PipeBodyR:return t(`#2f9e44`,.4,.15);case Y.Platform:return t(`#d9c48a`,.7);case Y.Spike:return t(`#c0c6d0`,.35,.55);case Y.Spring:return t(`#3d7ea6`,.45,.25);case Y.Ice:return t(`#a8d8f0`,.25,.15,`#204060`,.08);case Y.Lava:return t(`#e24b1a`,.55,.05,`#ff4a00`,.55);case Y.Bridge:return t(`#8b5a2b`,.8);case Y.Castle:return t(`#6a6a72`,.75);default:return null}}makeMovingGhost(e){let t=this.getMat(`plat-${e}`,()=>new K({color:e===`h`?`#d4b56a`:`#c9a84c`,roughness:.5,metalness:.2,transparent:!0,opacity:.85})),n=new W(this.getGeo(new G(1.4,.22,.9)),t),r=this.getMat(`plat-arrow`,()=>new K({color:`#7ec8f0`,emissive:`#2a6a90`,emissiveIntensity:.4})),i=new W(this.getGeo(new ji(.12,.22,3)),r);return e===`h`?(i.position.set(.78,0,0),i.rotation.z=-Math.PI/2):i.position.set(0,.28,0),n.add(i),n}makeEntityGhost(e){let t=new ln,n=`#ffffff`;e===Y.Goomba?n=`#8b4518`:e===Y.Koopa?n=`#2f9e44`:e===Y.Spiny?n=`#c23b2e`:e===Y.Coin?n=`#f5c542`:e===Y.Mushroom&&(n=`#e23d2e`);let r=this.getMat(`ent-ghost-${e}`,()=>new K({color:n,roughness:.5,transparent:!0,opacity:.75})),i=new W(this.getGeo(new Pi(.32,12,10)),r);if(t.add(i),e===Y.Spiny){let e=this.getMat(`ghost-spike`,()=>new K({color:`#f0d060`}));for(let[n,r]of[[0,.34],[-.14,.28],[.14,.28]]){let i=new W(this.getGeo(new ji(.07,.22,5)),e);i.position.set(n,r,0),t.add(i)}}return t}makeDeco(e){if(e===Y.Cloud){let e=this.getMat(`cloud`,()=>new K({color:`#ffffff`,roughness:.9})),t=new ln;for(let[n,r,i]of[[0,0,.45],[.4,-.05,.32],[-.4,-.05,.3]]){let a=new W(this.getGeo(new Pi(i,12,10)),e);a.position.set(n,r,0),t.add(a)}return new W(this.getGeo(new G(.01,.01,.01)),e),t.userData.isDeco=!0,t}if(e===Y.Bush){let e=this.getMat(`bush`,()=>new K({color:`#3d9a4a`,roughness:.8})),t=new ln;for(let[n,r]of[[-.25,.28],[0,.34],[.25,.28]]){let i=new W(this.getGeo(new Pi(r,12,10)),e);i.position.set(n,.1,0),t.add(i)}return t}if(e===Y.Hill){let e=this.getMat(`hill`,()=>new K({color:`#5cb85c`,roughness:.85})),t=new W(this.getGeo(new ji(1.4,1.8,5)),e);return t.position.y=.4,t}return null}decoY(e,t){return e===Y.Cloud?t:t-.5}makeFlag(){let e=new ln,t=this.getMat(`flag-pole`,()=>new K({color:`#d8dde8`,roughness:.35,metalness:.55})),n=this.getMat(`flag-cloth`,()=>new K({color:`#e23d2e`,roughness:.55,side:2})),r=this.getMat(`flag-ball`,()=>new K({color:`#f5c542`,metalness:.5,roughness:.35})),i=new W(this.getGeo(new Ai(.05,.05,4.2,8)),t);i.position.y=2,i.castShadow=!0,e.add(i);let a=new W(this.getGeo(new Pi(.12,12,10)),r);a.position.y=4.15,e.add(a);let o=new W(this.getGeo(new Mi(.7,.45)),n);o.position.set(.38,3.7,0),e.add(o);let s=new W(this.getGeo(new G(.7,.2,.7)),this.getMat(`flag-base`,()=>new K({color:`#888`,roughness:.7})));return s.position.y=.05,e.add(s),e}makeLabelSprite(e){let t=document.createElement(`canvas`);t.width=64,t.height=64;let n=t.getContext(`2d`);n&&(n.clearRect(0,0,64,64),n.fillStyle=`#5a3a00`,n.font=`bold 48px sans-serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,32,34));let r=new Ti(t);return r.colorSpace=ze,new Mr(new vr({map:r,transparent:!0}))}};function tu(e){let t=0;for(let n=0;n<e.length;n+=1)t=t*31+e.charCodeAt(n)|0;return t}var nu=[{code:Y.Empty,label:`橡皮`,key:`0`},{code:Y.Ground,label:`地面`,key:`1`},{code:Y.Brick,label:`砖块`,key:`2`},{code:Y.Question,label:`问号`,key:`3`},{code:Y.Platform,label:`平台`,key:`4`},{code:Y.PipeTopL,label:`水管`,key:`5`},{code:Y.Spike,label:`尖刺`,key:`6`},{code:Y.Spring,label:`弹簧`,key:`7`},{code:Y.Ice,label:`冰面`,key:`8`},{code:Y.Lava,label:`熔岩`,key:`9`},{code:Y.PlatformH,label:`横移台`,key:`H`},{code:Y.PlatformV,label:`竖移台`,key:`V`},{code:Y.Coin,label:`金币`,key:`C`},{code:Y.Goomba,label:`板栗·可踩`,key:`G`},{code:Y.Koopa,label:`乌龟·可踩`,key:`K`},{code:Y.Spiny,label:`刺猬·禁踩`,key:`P`},{code:Y.Flag,label:`终点旗`,key:`F`},{code:Y.Start,label:`起点`,key:`S`},{code:Y.Bush,label:`灌木`,key:`B`},{code:Y.Cloud,label:`云朵`,key:`L`}],ru=class{brush=Y.Ground;eraseMode=!1;lastPaint={x:-1,y:-1};setBrush(e){this.brush=e}paintAt(e,t,n,r){if(t<0||n<0||t>=e.width||n>=e.height||this.lastPaint.x===t&&this.lastPaint.y===n)return!1;let i=r||this.eraseMode||this.brush===Y.Empty?Y.Empty:this.brush;if(i===Y.Start)for(let t=0;t<e.tiles.length;t+=1)e.tiles[t]===Y.Start&&(e.tiles[t]=Y.Empty);if(i===Y.Flag)for(let t=0;t<e.tiles.length;t+=1)e.tiles[t]===Y.Flag&&(e.tiles[t]=Y.Empty);return i===Y.PipeTopL&&t+1<e.width?(gl(e,t,n,Y.PipeTopL),gl(e,t+1,n,Y.PipeTopR),n+1<e.height&&$l(iu(e,t,n+1)).solid,this.lastPaint={x:t,y:n},!0):(gl(e,t,n,i),this.lastPaint={x:t,y:n},!0)}resetStroke(){this.lastPaint={x:-1,y:-1}}brushLabel(){return nu.find(e=>e.code===this.brush)?.label??`画笔`}validate(e){let t=[],n=e.tiles.includes(Y.Start),r=e.tiles.includes(Y.Flag);return n||t.push(`缺少起点 Start`),r||t.push(`缺少终点 Flag`),{ok:t.length===0,errors:t}}};function iu(e,t,n){return t<0||n<0||t>=e.width||n>=e.height?Y.Empty:e.tiles[n*e.width+t]}var au=class{menu;playHud;editorHud;overlay;touch;levelList;toolPalette;onMenuAction=null;onEditorBrush=null;constructor(){this.menu=this.el(`#menu-screen`),this.playHud=this.el(`#play-hud`),this.editorHud=this.el(`#editor-hud`),this.overlay=this.el(`#overlay-screen`),this.touch=this.el(`#touch-controls`),this.levelList=this.el(`#level-list`),this.toolPalette=this.el(`#tool-palette`)}setMenuHandler(e){this.onMenuAction=e,this.menu.querySelectorAll(`[data-action]`).forEach(e=>{e.onclick=()=>{let t=e.dataset.action??``;t.startsWith(`level:`),this.onMenuAction?.(t)}})}setEditorBrushHandler(e){this.onEditorBrush=e,this.toolPalette.querySelectorAll(`[data-brush]`).forEach(e=>{e.onclick=()=>{let t=Number(e.dataset.brush);this.toolPalette.querySelectorAll(`.tool-btn`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),this.onEditorBrush?.(t)}})}bindEditorActions(e){this.editorHud.querySelectorAll(`[data-edit-action]`).forEach(t=>{t.onclick=()=>e(t.dataset.editAction??``)})}bindOverlayActions(e){this.overlay.querySelectorAll(`[data-overlay-action]`).forEach(t=>{t.onclick=()=>e(t.dataset.overlayAction??``)})}bindMute(e){document.querySelectorAll(`[data-mute-toggle]`).forEach(t=>{t.onclick=()=>e()})}setMuted(e){document.querySelectorAll(`[data-mute-toggle]`).forEach(t=>{t.textContent=e?`🔇 静音`:`🔊 音乐`,t.setAttribute(`aria-pressed`,e?`true`:`false`),t.classList.toggle(`muted`,e)})}buildLevelList(e,t){this.levelList.innerHTML=``;let n=document.createElement(`div`);n.className=`list-title`,n.textContent=`官方 Demo`,this.levelList.appendChild(n);for(let t of e)this.levelList.appendChild(this.levelBtn(`level:${t.id}`,`${t.name}`,`${t.timeLimit}s`));if(t.length){let e=document.createElement(`div`);e.className=`list-title`,e.textContent=`我的关卡`,this.levelList.appendChild(e);for(let e of t)this.levelList.appendChild(this.levelBtn(`level:${e.id}`,e.name,`custom`))}}update(e){let t=e.mode===`menu`,n=e.mode===`edit`,r=e.mode===`play`||e.mode===`paused`||e.mode===`clear`||e.mode===`fail`;this.menu.classList.toggle(`hidden`,!t),this.playHud.classList.toggle(`hidden`,!r&&e.mode!==`edit`),this.editorHud.classList.toggle(`hidden`,!n),this.touch.classList.toggle(`hidden`,!r),this.touch.setAttribute(`aria-hidden`,r?`false`:`true`),this.setText(`#level-name`,e.levelName||`—`),this.setText(`#coin-value`,String(e.coins).padStart(2,`0`)),this.setText(`#time-value`,ou(e.timeLeft)),this.setText(`#death-value`,String(e.deaths)),e.editorTool&&this.setText(`#editor-tool-label`,e.editorTool),e.editorBrush&&this.setText(`#editor-brush-label`,e.editorBrush),e.muted!==void 0&&this.setMuted(e.muted),e.bgmLabel&&this.setText(`#bgm-label`,e.bgmLabel);let i=e.mode===`clear`||e.mode===`fail`||e.mode===`paused`;if(this.overlay.classList.toggle(`hidden`,!i),i){let t=e.mode===`clear`?`关卡完成！`:e.mode===`fail`?`再来一次`:`已暂停`;this.setText(`#overlay-title`,t);let n=e.mode===`clear`?`金币 ${e.coins} · 用时 ${ou(e.clearTime??0)}`:e.mode===`fail`?e.message??`跌落或被击中了`:`游戏已暂停`;this.setText(`#overlay-sub`,n),this.overlay.querySelectorAll(`[data-overlay-action]`).forEach(t=>{let n=t.dataset.overlayAction;t.classList.toggle(`hidden`,e.mode===`clear`&&n===`resume`),t.classList.toggle(`hidden`,e.mode!==`paused`&&n===`resume`),e.mode===`clear`&&(n===`retry`&&(t.textContent=`再玩一次`),n===`menu`&&(t.textContent=`回到菜单`),n===`edit`&&t.classList.remove(`hidden`)),e.mode===`fail`&&(n===`retry`&&(t.textContent=`重试`),n===`edit`&&t.classList.add(`hidden`))})}}levelBtn(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`level-btn`,r.dataset.action=e,r.innerHTML=`<span>${t}</span><small>${n}</small>`,r.onclick=()=>this.onMenuAction?.(e),r}setText(e,t){let n=document.querySelector(e);n&&(n.textContent=t)}el(e){let t=document.querySelector(e);if(!t)throw Error(`Missing UI node ${e}`);return t}};function ou(e){let t=Math.max(0,Math.ceil(e)),n=Math.floor(t/60),r=t%60;return`${String(n).padStart(2,`0`)}:${String(r).padStart(2,`0`)}`}function su(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}var cu=`blocksmith-levels-v1`,lu=`blocksmith-stars-v1`,uu=class{canvas;renderer;scene=new vn;camera=new Sa(-10,10,6,-6,-50,50);input;player=new Rl;hud=new au;audio=new Gl;editor=new ru;levelView=new eu;cameraRig=new Xl(this.camera,12);loop=new cl((e,t)=>this.update(e,t),()=>this.render());background=null;enemies=[];pickups=[];platforms=[];bumps=[];mode=`menu`;level=Al[0];playLevel=Al[0];coins=0;deaths=0;timeLeft=0;clearTime=0;message=``;maxDpr=2;frame=0;accumulator=0;rng=su(1);pausedForScreenshot=!1;reducedMotion=!1;hitstop=0;customLevels=[];stars={};currentLevelId=Al[0].id;pointerDownOnCanvas=!1;pointerAlt=!1;constructor(e){this.canvas=e,this.renderer=ll(e),this.renderer.toneMappingExposure=1.08,this.input=new ol(this.el(`#touch-stick`),this.el(`#touch-knob`),this.el(`#jump-button`),this.el(`#dash-button`),e),this.loadStorage(),this.setupLights(),this.levelView.group.position.z=0,this.scene.add(this.levelView.group),this.scene.add(this.player.group),this.hud.setMenuHandler(e=>this.handleMenuAction(e)),this.hud.setEditorBrushHandler(e=>this.editor.setBrush(e)),this.hud.bindEditorActions(e=>this.handleEditorAction(e)),this.hud.bindOverlayActions(e=>this.handleOverlayAction(e)),this.hud.bindMute(()=>this.toggleMute()),this.hud.buildLevelList(Al.map(e=>({id:e.id,name:e.name,timeLimit:e.timeLimit})),this.customLevels.map(e=>({id:e.id,name:e.name}))),this.installPointer(),this.installKeyboardShortcuts(),this.enterMenu(),this.installTestHooks(),this.publishDiagnostics(),window.addEventListener(`resize`,()=>this.handleResize())}start(){this.loop.start()}dispose(){this.loop.stop(),this.input.dispose(),this.audio.dispose(),this.levelView.dispose(),this.renderer.dispose(),window.__THREE_GAME_DIAGNOSTICS__=void 0,window.__THREE_GAME_TEST_HOOKS__=void 0}enterMenu(){this.mode=`menu`,this.clearDynamic(),this.player.group.visible=!1,this.levelView.rebuild(Al[0]),this.levelView.setTheme(Al[0],this.scene),this.background=new Kl(Al[0].theme),this.scene.add(this.background.group),this.cameraRig.snapTo(12,8,Al[0].width,Al[0].height),this.hud.buildLevelList(Al.map(e=>({id:e.id,name:e.name,timeLimit:e.timeLimit})),this.customLevels.map(e=>({id:e.id,name:e.name}))),this.syncBgm(`menu`),this.pushHud()}startLevel(e){let t=jl(e)??this.customLevels.find(t=>t.id===e);t&&(this.currentLevelId=e,this.playLevel=_l(t),this.mode=`play`,this.coins=0,this.timeLeft=this.playLevel.timeLimit,this.clearTime=0,this.message=``,this.hitstop=0,this.loadLevelIntoWorld(this.playLevel),this.audio.unlock(),this.audio.ui(),this.syncBgm(this.bgmForLevel(this.playLevel)),this.pushHud())}enterEditor(e){this.mode=`edit`,this.currentLevelId=e?.id??this.level.id??`custom-1`,this.level=_l(e??this.level??Ml()),this.clearDynamic(),this.player.group.visible=!1,this.levelView.rebuild(this.level),this.levelView.setTheme(this.level,this.scene),this.levelView.setGridVisible(this.level,!0),this.levelView.showEntityGhosts=!0,this.rebuildBackground(this.level.theme),this.cameraRig.snapTo(8,4.5,this.level.width,this.level.height),this.audio.unlock(),this.syncBgm(`editor`),this.pushHud()}playtestEditorLevel(){let e=this.editor.validate(this.level);if(!e.ok){this.message=e.errors.join(`；`),this.pushHud();return}this.currentLevelId=this.level.id,this.playLevel=_l(this.level),this.mode=`play`,this.coins=0,this.timeLeft=this.playLevel.timeLimit,this.clearTime=0,this.message=``,this.loadLevelIntoWorld(this.playLevel),this.audio.unlock(),this.audio.ui(),this.syncBgm(this.bgmForLevel(this.playLevel)),this.pushHud()}bgmForLevel(e){return e.theme===`underground`||e.theme===`castle`?`underground`:`play`}syncBgm(e){this.audio.unlock(),this.audio.playBgm(e)}toggleMute(){let e=this.audio.toggleMute();this.hud.setMuted(e),this.audio.ui()}returnToMenu(){this.saveEditorIfNeeded(),this.enterMenu()}loadLevelIntoWorld(e){this.clearDynamic(),this.levelView.rebuild(e),this.levelView.setTheme(e,this.scene),this.levelView.setGridVisible(e,!1),this.levelView.showEntityGhosts=!1,this.rebuildBackground(e.theme);let t=vl(e,Y.Start)[0]??{x:3,y:e.height-3},n=yl(t.x,t.y,e.height),r=n.y-.5+Q.playerHalfH;this.player.reset(n.x,r),this.player.group.visible=!0,this.spawnEntities(e),this.cameraRig.snapTo(this.player.group.position.x,this.player.group.position.y,e.width,e.height),this.accumulator=0}spawnEntities(e){this.enemies=[],this.pickups=[],this.platforms=[],this.levelView.dynamicGroup.clear();let t=0;for(let n=0;n<e.height;n+=1)for(let r=0;r<e.width;r+=1){let i=e.tiles[n*e.width+r],a=yl(r,n,e.height);if(i===Y.Coin){let e=new Hl(`coin`,a.x,a.y,this.rng()*Math.PI*2);this.pickups.push(e),this.levelView.dynamicGroup.add(e.group)}else if(i===Y.Goomba||i===Y.Koopa||i===Y.Spiny){let e=new Bl(i===Y.Goomba?`goomba`:i===Y.Spiny?`spiny`:`koopa`,a.x,a.y-.05);e.startX=a.x,e.velocity.x=-e.speed,this.enemies.push(e),this.levelView.dynamicGroup.add(e.group)}else if(i===Y.Mushroom){let e=new Hl(`mushroom`,a.x,a.y);e.velocity.x=2.2,this.pickups.push(e),this.levelView.dynamicGroup.add(e.group)}else if(i===Y.PlatformH||i===Y.PlatformV){let e=i===Y.PlatformH?`h`:`v`,n=t*1.3;t+=1;let r=new Vl(a.x,a.y,e,e===`h`?2.8:2.2,1.25+t%3*.2,n);this.platforms.push(r),this.levelView.dynamicGroup.add(r.group)}}}clearDynamic(){for(let e of this.enemies)this.levelView.dynamicGroup.remove(e.group);for(let e of this.pickups)this.levelView.dynamicGroup.remove(e.group);for(let e of this.platforms)this.levelView.dynamicGroup.remove(e.group);for(let e of this.levelView.dynamicGroup.children.slice())e.userData.pickup&&this.levelView.dynamicGroup.remove(e);this.enemies=[],this.pickups=[],this.platforms=[],this.bumps=[]}rebuildBackground(e){this.background&&this.scene.remove(this.background.group),this.background=new Kl(e),this.scene.add(this.background.group)}update(e,t){this.frame+=1,ul(this.renderer,this.camera,this.maxDpr),this.handleResize();let n=this.input.poll();if(this.audio.unlock(),this.pausedForScreenshot){this.publishDiagnostics();return}if(this.mode===`edit`){this.updateEditor(n),this.background?.update(this.camera.position.x,this.level.width),this.pushHud(),this.publishDiagnostics();return}if(this.mode===`menu`){this.background?.update(this.camera.position.x,Al[0].width),this.pushHud(),this.publishDiagnostics();return}if(n.pausePressed&&(this.mode===`play`||this.mode===`paused`)){this.mode=this.mode===`play`?`paused`:`play`,this.audio.ui(),this.mode===`paused`?this.audio.duckBgm(.35,.2):this.syncBgm(this.bgmForLevel(this.playLevel)),this.pushHud(),this.publishDiagnostics();return}if(this.mode===`paused`||this.mode===`clear`||this.mode===`fail`){this.background?.update(this.camera.position.x,this.playLevel.width),this.pushHud(),this.publishDiagnostics();return}if(this.hitstop>0)this.hitstop-=e;else{for(this.accumulator=Math.min(this.accumulator+e,Q.maxAccumulator);this.accumulator>=Q.fixedDt;)this.step(Q.fixedDt),this.accumulator-=Q.fixedDt;this.clearTime+=e}let r=this.reducedMotion?0:e;this.player.setReducedAnim(this.reducedMotion),this.player.frameVisual(r);for(let e of this.platforms)e.update(r,this.reducedMotion);if(this.player.isDead&&this.player.deadFinished&&this.mode===`play`){this.mode=`fail`,this.deaths+=1,this.syncBgm(`fail`),this.pushHud(),this.publishDiagnostics();return}for(let e of this.pickups)e.update(r,this.reducedMotion);this.cleanupPickups(),this.updateBumps(e),this.background?.update(this.player.group.position.x,this.playLevel.width),this.cameraRig.update(e,this.player.group.position.x,this.player.group.position.y,this.playLevel.width,this.playLevel.height),this.pushHud(),this.publishDiagnostics()}step(e){if(this.mode!==`play`)return;let t=this.playLevel,n=this.input.intents;if(this.player.isDead)return;if(this.timeLeft-=e,this.timeLeft<=0){this.timeLeft=0,this.killPlayer(`时间到！`);return}let r={x:this.player.group.position.x,y:this.player.group.position.y,halfW:Q.playerHalfW,halfH:Q.playerHalfH},i=this.player.velocity.x,a=this.player.velocity.y,o=this.makeTileQueries(t),s=r.y-r.halfH,c=o.tileYFromWorld(s-Q.groundSnapDist*.5),l=Math.floor(r.x-r.halfW+.02),u=Math.floor(r.x+r.halfW-.02),d=!1;if(a<=.01){for(let e=l;e<=u;e+=1)if(o.isSolid(e,c)||o.isOneWay(e,c)){let e=o.tileCenterY(c)+.5;if(s>=e-Q.groundSnapDist&&s<=e+.08){r.y=e+r.halfH,d=!0;break}}}let f=null;for(let e of this.platforms)if(e.isStandingOn(r)||a<=0&&e.tryLand(r,s,a)){f=e,r.y=e.topY+r.halfH;break}let p=d||f!==null||this.player.onGround;p&&a<0&&(a=0);let m=Pl(n.moveX,-1,1),h=n.dashHeld?Q.dashSpeed:Q.runSpeed,g=this.tileAtWorld(r.x,r.y-r.halfH-.02,t)===Y.Ice,_=p||this.player.onGround,v=g?Q.iceAccel:_?Q.accelGround:Q.accelAir,y=g?Q.iceFriction:_?Q.frictionGround:Q.frictionAir;this.player.state!==`clear`&&this.player.state!==`dead`&&(i=f&&m===0?f.velocity.x:m===0?Fl(i,0,y*e):Fl(i,m*h+(f?.velocity.x??0)*.35,v*e)),_?(this.player.coyotePublic=Q.coyoteTime,this.player.airJumpsUsed=0):this.player.coyotePublic-=e,n.jumpPressed?this.player.jumpBufferPublic=Q.jumpBuffer:this.player.jumpBufferPublic-=e;let b=!1;this.player.jumpBufferPublic>0&&this.player.state!==`clear`&&(this.player.coyotePublic>0||_?(a=Q.jumpVel,this.player.onGround=!1,this.player.coyotePublic=0,this.player.jumpBufferPublic=0,this.player.airJumpsUsed=0,this.player.jumpHoldPublic=0,b=!0,this.audio.jump()):this.player.airJumpsUsed<Q.maxAirJumps&&(a=Q.doubleJumpVel,this.player.airJumpsUsed+=1,this.player.jumpBufferPublic=0,this.player.jumpHoldPublic=0,b=!0,this.audio.jump(),this.audio.spring(),this.cameraRig.addTrauma(.08))),(b||!_&&a>0&&this.player.jumpHoldPublic>=0)&&n.jumpHeld&&(this.player.jumpHoldPublic+=e),!n.jumpHeld&&a>0&&this.player.jumpHoldPublic>=Q.jumpCutDelay?a*=Q.jumpCutMultiplier:!n.jumpHeld&&a>0&&this.player.jumpHoldPublic>0&&this.player.jumpHoldPublic<Q.jumpCutDelay&&(a*=.75),a-=Q.gravity*e,a<-Q.maxFall&&(a=-Q.maxFall);let x=r.y-r.halfH,S=Il(r,i,a,e,o.isSolid,o.isOneWay,o.isHazard,o.isIce,o.tileCenterY,o.tileYFromWorld,o.tileXFromWorld);S.hitWall&&(i=0),S.hitFloor?(a=0,this.player.onGround=!0):this.player.onGround=!1;let C=!1,w=0,T=0;for(let e of this.platforms)if(e.tryLand(r,x,a)||e.isStandingOn(r)){r.y=e.topY+r.halfH,a<0&&(a=0),this.player.onGround=!0,C=!0,w=e.velocity.x,T=e.velocity.y;break}if(C&&(r.x+=w*e,T>0&&(r.y+=T*e),n.moveX===0&&!b&&(i=w)),S.hitCeiling&&(a=Math.min(a,-1),this.handleCeilingBumps(S.ceilingTiles,t)),S.onIce?this.player.onIce=!0:this.player.onIce=!1,Ll(r,o.isHazard,o.tileYFromWorld,o.tileXFromWorld)){this.killPlayer(`被陷阱击中`);return}if(r.y<-2){this.killPlayer(`掉进了深渊`);return}let E=S.hitFloor||C||d;if(this.player.syncFromPhysics(r.x,r.y,i,a,E,S.onIce),this.player.frameVisual(e),E){let e=o.tileYFromWorld(r.y-r.halfH-.05),n=Math.floor(r.x-r.halfW),a=Math.floor(r.x+r.halfW);for(let o=n;o<=a;o+=1)if(du(t,o,e)===Y.Spring){this.player.spring(),this.player.syncFromPhysics(r.x,r.y,i,Q.springVel,!1,!1),this.audio.spring(),this.cameraRig.addTrauma(.25);break}}this.updateEnemies(e,t,o),this.updatePickupCollisions(t),this.updateFlag(t)}makeTileQueries(e){let t=e.height;return{isSolid:(t,n)=>dl.has(du(e,t,n)),isOneWay:(t,n)=>pl.has(du(e,t,n)),isHazard:(t,n)=>fl.has(du(e,t,n)),isIce:(t,n)=>du(e,t,n)===Y.Ice,tileCenterY:e=>t-1-e+.5,tileYFromWorld:e=>t-1-Math.floor(e),tileXFromWorld:e=>Math.floor(e)}}tileAtWorld(e,t,n){let r=bl(e,t,n.height);return du(n,r.x,r.y)}handleCeilingBumps(e,t){for(let n of e){let e=du(t,n.x,n.y);if(e===Y.Question||e===Y.Brick){let r=yl(n.x,n.y,t.height);if(this.bumps.push({x:n.x,y:n.y,t:Q.bumpDuration,code:e}),e===Y.Question){t.tiles[n.y*t.width+n.x]=Y.UsedBlock,this.coins+=1,this.audio.coin();let e=Ul(r.x,r.y+.6);e.group.userData.pickup=!0,this.pickups.push(e),this.levelView.dynamicGroup.add(e.group)}else e===Y.Brick&&(t.tiles[n.y*t.width+n.x]=Y.Empty,this.audio.breakBrick(),this.cameraRig.addTrauma(.2));this.audio.bump(),this.levelView.rebuild(t),this.respawnStaticEntities(t)}}}respawnStaticEntities(e){}updateBumps(e){for(let t=this.bumps.length-1;t>=0;--t){let n=this.bumps[t];n.t-=e;let r=this.levelView.getBumpMesh(n.x,n.y);if(r){let t=n.t/Q.bumpDuration;r.position.y+=Math.sin(t*Math.PI)*.15*e*20}if(n.t<=0){let e=yl(n.x,n.y,this.playLevel.height);r&&r.position.set(e.x,e.y,0),this.bumps.splice(t,1)}}}updateEnemies(e,t,n){let r=this.player.aabb;for(let t=this.enemies.length-1;t>=0;--t){let i=this.enemies[t];if(i.removed){this.levelView.dynamicGroup.remove(i.group),this.enemies.splice(t,1);continue}let a={x:i.group.position.x,y:i.group.position.y,halfW:i.halfW,halfH:i.halfH},o=i.velocity.x,s=i.velocity.y;s-=Q.gravity*e;let c=o>0?a.x+a.halfW+.08:a.x-a.halfW-.08,l=n.tileXFromWorld(c),u=n.tileYFromWorld(a.y-a.halfH+.05),d=n.tileYFromWorld(a.y+a.halfH-.05),f=n.isSolid(l,u)||n.isSolid(l,d),p=n.isSolid(l,u-1)||n.isOneWay(l,u-1),m=f||!p&&i.state===`walk`,h=Il(a,o,s,e,n.isSolid,n.isOneWay,n.isHazard,n.isIce,n.tileCenterY,n.tileYFromWorld,n.tileXFromWorld);if((h.hitWall||m)&&(i.facing*=-1,o=i.facing*(i.state===`shellSlide`?10.5:i.speed)),h.hitFloor&&(s=0),(Ll(a,n.isHazard,n.tileYFromWorld,n.tileXFromWorld)||a.y<-2)&&i.killFall(),i.group.position.set(a.x,a.y,0),i.velocity.set(o,s),i.update(this.reducedMotion?0:e,!1),this.player.isDead||this.player.state===`clear`||!Nl(r,i.aabb))continue;let g=r.y-r.halfH,_=i.aabb.y+i.aabb.halfH,v=this.player.velocity.y<-.5&&g<_-.12;if(!i.canStomp){this.killPlayer(`被刺猬扎到了（不可踩）`);return}if(v&&i.state!==`shellSlide`)i.squash(),this.player.bounce(),this.audio.stomp(),this.cameraRig.addTrauma(.35),this.hitstop=Q.hitstopSec;else if(i.kind===`koopa`&&(i.state===`shell`||i.state===`shellSlide`)){if(i.state===`shell`){let e=r.x<i.aabb.x?1:-1;i.kickShell(e),this.player.velocity.x=e*4,this.audio.stomp()}else if(v)i.state=`shell`,i.velocity.x=0,this.player.bounce(),this.audio.stomp();else{this.killPlayer(`被龟壳撞到了`);return}}else{this.killPlayer(`碰到了敌人`);return}}}updatePickupCollisions(e){let t=this.player.aabb;for(let e of this.pickups)e.active&&Nl(t,{x:e.group.position.x,y:e.group.position.y,halfW:Q.coinRadius,halfH:Q.coinRadius})&&(e.kind===`coin`||e.kind===`coinPop`?(this.coins+=1,e.collect(),this.audio.coin(),this.cameraRig.addTrauma(.12)):e.kind===`mushroom`&&(e.collect(),this.coins+=5,this.audio.spring(),this.cameraRig.addTrauma(.3)));let n=this.makeTileQueries(e);for(let e of this.pickups){if(!e.active||e.kind!==`mushroom`)continue;let t={x:e.group.position.x,y:e.group.position.y,halfW:.28,halfH:.28},r=Il(t,e.velocity.x,e.velocity.y,Q.fixedDt,n.isSolid,n.isOneWay,n.isHazard,n.isIce,n.tileCenterY,n.tileYFromWorld,n.tileXFromWorld);r.hitWall&&(e.velocity.x*=-1),r.hitFloor?e.velocity.y=0:e.velocity.y=Math.max(e.velocity.y-28*Q.fixedDt,-20),e.group.position.set(t.x,t.y,0)}}cleanupPickups(){for(let e=this.pickups.length-1;e>=0;--e){let t=this.pickups[e];(t.finished||!t.active&&t.kind!==`coinPop`)&&(t.kind!==`coinPop`||t.finished)&&(this.levelView.dynamicGroup.remove(t.group),this.pickups.splice(e,1))}}updateFlag(e){let t=vl(e,Y.Flag);if(!t.length)return;let n=t[0],r=yl(n.x,n.y,e.height),i={x:r.x,y:r.y+1.5,halfW:.55,halfH:2.2};if(!Nl(this.player.aabb,i))return;this.mode=`clear`,this.player.markClear(),this.clearTime=this.playLevel.timeLimit-this.timeLeft,this.audio.clear(),this.syncBgm(`clear`),this.cameraRig.addTrauma(.4);let a=this.computeStars();this.stars[this.currentLevelId]=Math.max(this.stars[this.currentLevelId]??0,a),this.saveStorage(),this.pushHud()}computeStars(){let e=1;return this.coins>=5&&(e+=1),this.timeLeft>this.playLevel.timeLimit*.35&&(e+=1),e}killPlayer(e){this.player.isDead||(this.player.kill(),this.audio.die(),this.audio.duckBgm(.2,.5),this.cameraRig.addTrauma(.6),this.message=e)}updateEditor(e){let t=this.canvas.getBoundingClientRect();if(e.pointerDown||e.pointerDownPrev){let n=this.cameraRig.screenToWorld(e.pointerX,e.pointerY,t.width,t.height),r=bl(n.x,n.y,this.level.height),i=e.pointerAlt||e.eraserHeld||this.editor.brush===Y.Empty;this.editor.paintAt(this.level,r.x,r.y,i)&&(this.levelView.rebuild(this.level),this.levelView.setGridVisible(this.level,!0),this.audio.place()),e.pointerDown||this.editor.resetStroke()}else this.editor.resetStroke();let n=this.cameraRig.viewBounds,r=.25,i=n.x,a=n.y;e.moveX<0&&(i-=r),e.moveX>0&&(i+=r),e.downHeld&&(a-=r),e.jumpHeld&&(a+=r),this.cameraRig.snapTo(i,a,this.level.width,this.level.height),this.background?.update(i,this.level.width)}handleEditorAction(e){if(e===`play`){this.playtestEditorLevel();return}if(e===`save`){this.saveCustomLevel(this.level),this.message=`已保存`,this.audio.ui(),this.pushHud();return}if(e===`clear`){this.level=Ml(this.level.id,this.level.name),this.levelView.rebuild(this.level),this.levelView.setGridVisible(this.level,!0),this.audio.ui();return}if(e===`menu`){this.returnToMenu();return}e===`grid`&&this.levelView.setGridVisible(this.level,!this.levelView.showGrid)}handleMenuAction(e){if(e.startsWith(`level:`)){this.startLevel(e.slice(6));return}if(e===`edit`||e===`continue`){let e=this.customLevels[0];this.enterEditor(e??Ml());return}if(e===`blank`){this.enterEditor(Ml(`custom-${Date.now()}`,`自定义 ${this.customLevels.length+1}`));return}}handleOverlayAction(e){if(e===`retry`){this.startLevel(this.currentLevelId);return}if(e===`resume`){this.mode=`play`,this.pushHud();return}if(e===`menu`){this.returnToMenu();return}e===`edit`&&this.enterEditor(this.playLevel)}saveEditorIfNeeded(){this.level&&this.level.tiles.some(e=>e!==0)}saveCustomLevel(e){let t=this.customLevels.findIndex(t=>t.id===e.id),n=_l(e);t>=0?this.customLevels[t]=n:this.customLevels.push(n),this.saveStorage(),this.hud.buildLevelList(Al.map(e=>({id:e.id,name:e.name,timeLimit:e.timeLimit})),this.customLevels.map(e=>({id:e.id,name:e.name})))}loadStorage(){try{let e=localStorage.getItem(cu);if(e){let t=JSON.parse(e);this.customLevels=t.map(e=>Sl(e))}let t=localStorage.getItem(lu);t&&(this.stars=JSON.parse(t))}catch{this.customLevels=[],this.stars={}}}saveStorage(){try{localStorage.setItem(cu,JSON.stringify(this.customLevels.map(e=>xl(e)))),localStorage.setItem(lu,JSON.stringify(this.stars))}catch{}}installPointer(){this.canvas.addEventListener(`pointerdown`,e=>{this.pointerDownOnCanvas=!0,this.pointerAlt=e.button===2||e.shiftKey,this.input.setPointerFromClient(e.clientX,e.clientY,!0,this.pointerAlt);try{this.canvas.setPointerCapture(e.pointerId)}catch{}}),this.canvas.addEventListener(`pointermove`,e=>{this.pointerDownOnCanvas&&this.input.setPointerFromClient(e.clientX,e.clientY,!0,this.pointerAlt||e.shiftKey)});let e=e=>{this.pointerDownOnCanvas=!1,this.input.setPointerFromClient(e.clientX,e.clientY,!1,this.pointerAlt)};this.canvas.addEventListener(`pointerup`,e),this.canvas.addEventListener(`pointercancel`,e)}installKeyboardShortcuts(){window.addEventListener(`keydown`,e=>{if(e.code===`KeyM`){this.toggleMute(),e.preventDefault();return}if(this.mode===`play`&&e.code===`KeyR`){this.startLevel(this.currentLevelId),e.preventDefault();return}if(this.mode!==`edit`)return;(e.code===`KeyP`||e.code===`Enter`)&&(this.handleEditorAction(`play`),e.preventDefault()),e.code===`KeyS`&&(e.ctrlKey||e.metaKey)&&(this.handleEditorAction(`save`),e.preventDefault());let t={Digit0:0,Digit1:1,Digit2:2,Digit3:3,Digit4:4,Digit5:5,Digit6:6,Digit7:7,Digit8:8,Digit9:9};if(t[e.code]!==void 0){let n=[Y.Empty,Y.Ground,Y.Brick,Y.Question,Y.Platform,Y.PipeTopL,Y.Spike,Y.Spring,Y.Ice,Y.Lava][t[e.code]];this.editor.setBrush(n),document.querySelectorAll(`#tool-palette .tool-btn`).forEach(e=>{let t=e;t.classList.toggle(`active`,Number(t.dataset.brush)===n)}),this.pushHud()}})}render(){this.renderer.render(this.scene,this.camera)}handleResize(){let e=Math.max(1,this.canvas.clientWidth),t=Math.max(1,this.canvas.clientHeight);this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,this.maxDpr)),this.renderer.setSize(e,t,!1),this.cameraRig.applyProjection(e/t)}pushHud(){let e={mode:this.mode,levelName:this.mode===`edit`?`编辑 · ${this.level.name}`:this.mode===`menu`?`像素工坊`:this.playLevel.name,coins:this.coins,timeLeft:this.mode===`menu`?0:this.timeLeft,lives:3,deaths:this.deaths,message:this.message,editorTool:this.mode===`edit`?this.editor.brush===Y.Empty?`橡皮`:`画笔`:void 0,editorBrush:this.mode===`edit`?this.editor.brushLabel():void 0,clearTime:this.clearTime,muted:this.audio.isMuted,bgmLabel:this.bgmLabel()};this.hud.update(e)}bgmLabel(){return{menu:`菜单曲`,play:`地上关`,underground:`地下关`,editor:`编辑曲`,clear:`通关曲`,fail:`失败曲`,none:`无音乐`}[this.audio.currentBgm]??``}setupLights(){let e=new la(`#e8f4ff`,`#3a4a30`,1.35);this.scene.add(e);let t=new wa(`#fff2c8`,2.2);t.position.set(-8,16,12),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=1,t.shadow.camera.far=50,t.shadow.camera.left=-20,t.shadow.camera.right=20,t.shadow.camera.top=20,t.shadow.camera.bottom=-10,this.scene.add(t)}installTestHooks(){window.__THREE_GAME_TEST_HOOKS__={seed:e=>{this.rng=su(e)},setState:e=>{if(e===`menu`)this.enterMenu();else if(e===`active-play`||e===`play`)this.startLevel(Al[0].id);else if(e===`demo-2`)this.startLevel(`demo-2`);else if(e===`demo-3`)this.startLevel(`demo-3`);else if(e===`demo-4`)this.startLevel(`demo-4`);else if(e===`demo-5`)this.startLevel(`demo-5`);else if(e===`edit`||e===`editor`)this.enterEditor(Ml(`test-edit`,`测试编辑`));else if(e===`complete`)this.startLevel(Al[0].id),this.coins=8,this.mode=`clear`,this.player.markClear(),this.clearTime=42;else if(e===`fail`)this.startLevel(Al[0].id),this.killPlayer(`测试失败`),this.mode=`fail`,this.deaths=1;else if(e===`paused`)this.startLevel(Al[0].id),this.mode=`paused`;else throw Error(`Unknown test state: ${e}`);return this.render(),this.publishDiagnostics(),{state:e}},setPausedForScreenshot:e=>{this.pausedForScreenshot=e},setReducedMotion:e=>{if(this.reducedMotion=e,e){this.player.stabilizeVisuals();for(let e of this.pickups)e.stabilizeVisuals();for(let e of this.enemies)e.stabilizeVisuals()}this.render(),this.publishDiagnostics()},hideDebugUi:()=>{},listLevels:()=>Al.map(e=>e.id)}}publishDiagnostics(){let e=this.renderer.info;window.__THREE_GAME_DIAGNOSTICS__={frame:this.frame,mode:this.mode,levelId:this.mode===`edit`?this.level.id:this.playLevel.id,levelName:this.mode===`edit`?this.level.name:this.playLevel.name,coins:this.coins,timeLeft:this.timeLeft,deaths:this.deaths,complete:this.mode===`clear`,failed:this.mode===`fail`,enemies:this.enemies.length,pickups:this.pickups.length,player:{x:this.player.group.position.x,y:this.player.group.position.y,state:this.player.state,onGround:this.player.onGround,vy:this.player.velocity.y,mode:this.mode},renderer:{calls:e.render.calls,triangles:e.render.triangles,geometries:e.memory.geometries,textures:e.memory.textures},canvas:{clientWidth:this.canvas.clientWidth,clientHeight:this.canvas.clientHeight,width:this.canvas.width,height:this.canvas.height},palette:nu.length}}el(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element ${e}`);return t}};function du(e,t,n){return t<0||n<0||t>=e.width||n>=e.height?n>=e.height||n<0?Y.Empty:t<0||t>=e.width?Y.Ground:Y.Empty:e.tiles[n*e.width+t]}var fu=document.querySelector(`#game-canvas`);if(!fu)throw Error(`Missing #game-canvas element.`);new uu(fu).start();